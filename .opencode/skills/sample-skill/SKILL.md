---
name: sample-skill
description: Use when the user says sample skill, skill demo, or asks how a Thinksoft SKILL.md should be structured; demonstrates a tiny project-local skill with practical assistant workflow guidance.
---

# Sample Skill

This is a minimal project-local Thinksoft skill. It exists as a reference for how a skill is structured and as a tiny reusable workflow the assistant can load when the user asks for a skill example.
...
Restart Thinksoft for the new skill to be discovered by future sessions.
```
