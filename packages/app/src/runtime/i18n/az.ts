export const dict = {
  ...
  "desktop.recovery.loadFailed": "Thinksoft yüklənə bilmədi",
  "desktop.recovery.terminated": "Thinksoft pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Thinksoft cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoft quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Thinksoft yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Thinksoft tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Thinksoft-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Thinksoft-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Thinksoft-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Thinksoft serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Thinksoft yoxlanılır…",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Thinksoft yoxlanılır…",
  "wsl.onboarding.updatingOpencode": "Thinksoft yenilənir…",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Thinksoft yenilənir…",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Thinksoft-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Thinksoft-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "Thinksoft hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Thinksoft-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Thinksoft quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Thinksoft WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Thinksoft-u yenidən açın.",
  ...
  "toast.update.description": "Thinksoft-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Thinksoft komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Thinksoft hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Thinksoft serverini işlət.",
  ...
  "settings.general.row.language.description": "Thinksoft üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Thinksoft-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Thinksoft-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Thinksoft-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Thinksoft açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Thinksoft-un ən son versiyasından istifadə edirsiniz.",
  ...
  "server.row.incompatible":
    "Bu server bu tətbiqlə uyğun olmayan Thinksoft {{version}} versiyasını işlədir. Davam etmək üçün onu Thinksoft V2-yə yeniləyin.",
  ...
  "session.error.incompatible.description":
    "{{server}} bu tətbiqlə uyğun olmayan Thinksoft {{version}} versiyasını işlədir. Davam etmək üçün serveri Thinksoft V2-yə yeniləyin.",
  ...
  "settings.about.description": "Thinksoft, açıq mənbəli kodlaşdırma agenti",
  ...
  "ssh.stage.checking": "Thinksoft yoxlanılır…",
  "ssh.stage.downloading": "Server yüklənir…",
  "ssh.stage.uploading": "Server yüklənir…",
  "ssh.stage.starting": "Thinksoft-a qoşulur…",
  ...
  "ssh.error.service": "SSH bağlantısı quruldu, lakin Thinksoft serveri hazır vəziyyətə gəlmədi.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Bu, Thinksoft qoşulma kodu deyil. opencode pair tərəfindən göstərilən kodu skan edin.",
  ...
  "project.settings.name.description": "Bu layihə üçün Thinksoft boyunca göstərilən ad",
  ...
  "project.settings.extensions.empty.mcps.description": "Thinksoft üçün mövcud MCP-lər burada görünəcək",
  "project.settings.extensions.empty.plugins.title": "Hələ plagin yoxdur",
  "project.settings.extensions.empty.plugins.description": "Thinksoft üçün mövcud plaginlər burada görünəcək",
  "project.settings.extensions.empty.skills.title": "Hələ bacarıq yoxdur",
  "project.settings.extensions.empty.skills.description": "Thinksoft üçün mövcud bacarıqlar burada görünəcək",
  ...
  "settings.workspaces.empty.description": "Thinksoft-da yaradılan iş ağacları burada görünəcək",
  ...
  "settings.updates.action.download": "Thinksoft-u endir",
  "settings.updates.migration.title": "Beta-dan Stable-a keçin",
  "settings.updates.migration.description":
    "Hələlik Thinksoft Beta, Thinksoft Stable-a keçir. Yeniləmələri almağa davam etmək üçün {{version}} versiyasını endirin, sonra Thinksoft-u disk obrazından quraşdırın.",
