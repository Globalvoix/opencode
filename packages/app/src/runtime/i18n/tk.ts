export const dict = {
  ...
  "desktop.menu.documentation": "Thinksoft Resminamalar",
  ...
  "desktop.menu.ariaLabel": "Thinksoft menýusy",
  ...
  "desktop.recovery.loadFailed": "Thinksoft ýükläp bilmedi",
  "desktop.recovery.terminated": "Thinksoft penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "Thinksoft jogap berenok",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoft gurmak şowsuz",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "Thinksoft täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Thinksoft tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we Thinksoft-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Thinksoft-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Thinksoft-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.server.description": "Bu programmanyň haýsy Thinksoft serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpencode": "Thinksoft barlamak …",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Thinksoft barlanýar…",
  "wsl.onboarding.updatingOpencode": "Thinksoft täzelenmek …",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-de Thinksoft täzelenmek …",
  "wsl.onboarding.updateOpencodeIn": "Thinksoft-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpencode": "Thinksoft täzeläň",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft {{distro}}-de taýýar.",
  "wsl.onboarding.opencodeReady": "Thinksoft taýýar.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-de Thinksoft guruň.",
  "wsl.onboarding.installOpencode": "Thinksoft guruň",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) Thinksoft WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra Thinksoft açyň.",
  ...
  "toast.update.description": "Indi gurmak üçin Thinksoft ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy Thinksoft toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, Thinksoft entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "Thinksoft serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "Thinksoft üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "Thinksoft enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "Thinksoft ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "Thinksoft-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "Thinksoft işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "Thinksoft-iň iň soňky wersiýasyny işleýärsiňiz.",
  ...
  "server.row.incompatible":
    "Bu serwer şu programma bilen gabat gelmeýän Thinksoft {{version}} wersiýasyny işledýär. Dowam etmek üçin ony Thinksoft V2-ä täzeläň.",
  ...
  "session.error.incompatible.description":
    "{{server}} şu programma bilen gabat gelmeýän Thinksoft {{version}} wersiýasyny işledýär. Dowam etmek üçin serweri Thinksoft V2-ä täzeläň.",
  ...
  "settings.about.description": "Thinksoft, açyk çeşmeli kodlaşdyrma agenti",
  ...
  "ssh.error.service": "SSH birikdirildi, ýöne Thinksoft serweri taýýar bolmady.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Bu Thinksoft jübütleme kody däl. opencode pair görkezýän kody skanirläň.",
  ...
  "project.settings.name.description": "Thinksoft-da bu taslama üçin görkezilen at",
  ...
  "project.settings.extensions.empty.mcps.description": "Thinksoft üçin elýeterli MCP-ler şu ýerde peýda bolar",
  "project.settings.extensions.empty.plugins.title": "Entek plugin ýok",
  "project.settings.extensions.empty.plugins.description": "Thinksoft üçin elýeterli plaginler şu ýerde peýda bolar",
  "project.settings.extensions.empty.skills.title": "Entek başarnyk ýok",
  "project.settings.extensions.empty.skills.description": "Thinksoft-da bar bolan başarnyklar şu ýerde peýda bolar",
  ...
  "settings.workspaces.empty.description": "Thinksoft-da döredilen iş agaçlary şu ýerde peýda bolar",
  ...
  "settings.updates.action.download": "Thinksoft-y ýükläp al",
  "settings.updates.migration.title": "Beta-dan Stable-a geç",
  "settings.updates.migration.description":
    "Häzirlikçe Thinksoft Beta Thinksoft Stable-a geçýär. Täzelenmeleri almagy dowam etdirmek üçin {{version}} wersiýasyny ýükläp alyň, soňra Thinksoft-y disk şekilinden guruň.",
