export const dict = {
  ...
  "desktop.menu.documentation": "Thinksoft Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "Thinksoft մենյու",
  ...
  "desktop.recovery.loadFailed": "Thinksoft չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "Thinksoft պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "Thinksoft-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoft տեղադրումը ձախողվեց",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Thinksoft թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և Thinksoft-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և Thinksoft-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և Thinksoft-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ Thinksoft սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է Thinksoft-ը {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է Thinksoft-ը {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել Thinksoft-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.opencodeReady": "Thinksoft պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք Thinksoft-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի Thinksoft-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք Thinksoft։",
  ...
  "toast.update.description": "Thinksoft-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին Thinksoft թիմին",
  ...
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ Thinksoft-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "Thinksoft ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք Thinksoft սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն Thinksoft",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է Thinksoft տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ Thinksoft-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է Thinksoft-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ Thinksoft-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք Thinksoft-ի վերջին տարբերակը։",
  ...
  "server.row.incompatible":
    "Այս սերվերում աշխատում է Thinksoft {{version}}-ը, որն անհամատեղելի է այս հավելվածի հետ։ Շարունակելու համար թարմացրեք այն Thinksoft V2-ի։",
  ...
  "session.error.incompatible.description":
    "{{server}}-ում աշխատում է Thinksoft {{version}}-ը, որն անհամատեղելի է այս հավելվածի հետ։ Շարունակելու համար սերվերը թարմացրեք Thinksoft V2-ի։",
  ...
  "settings.about.description": "Thinksoft՝ բաց կոդով կոդավորման գործակալ",
  ...
  "ssh.stage.checking": "Ստուգում Thinksoft-ը…",
  "ssh.stage.downloading": "Ներբեռնում սերվերը…",
  "ssh.stage.uploading": "Վերբեռնում սերվերը…",
  "ssh.stage.starting": "Կապ հաստատվում է Thinksoft-ին…",
  ...
  "ssh.error.service": "SSH կապը հաստատված է, բայց Thinksoft սերվերը չի պատրաստվել:",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Սա Thinksoft-ի զուգակցման կոդ չէ։ Սկանավորեք opencode pair-ի ցուցադրած կոդը։",
  ...
  "project.settings.name.description": "Այս անունը կցուցադրվի նախագծի համար ամբողջ Thinksoft-ում",
  ...
  "project.settings.extensions.empty.mcps.description": "Thinksoft-ում հասանելի MCP-ները կցուցադրվեն այստեղ",
  "project.settings.extensions.empty.plugins.title": "Ավելացումներ դեռ չկան",
  "project.settings.extensions.empty.plugins.description": "Thinksoft-ի համար հասանելի ավելացումները կհայտնվեն այստեղ",
  "project.settings.extensions.empty.skills.title": "Կառավարվում հաստատված հմտություններ չունի",
  "project.settings.extensions.empty.skills.description": "Thinksoft-ի համար հասանելի կարողությունները կհայտնվեն այստեղ",
  ...
  "settings.workspaces.empty.description": "Thinksoft-ում ստեղծված աշխատանքային ծառերը կհայտնվեն այստեղ",
  ...
  "settings.updates.action.download": "Ներբեռնել Thinksoft-ը",
  "settings.updates.migration.title": "Beta-ից անցնել Stable-ի",
  "settings.updates.migration.description":
    "Առայժմ Thinksoft Beta-ն անցնում է Thinksoft Stable-ի։ Ներբեռնեք {{version}} տարբերակը, ապա տեղադրեք Thinksoft-ը սկավառակի պատկերից՝ թարմացումները շարունակելու համար։",
