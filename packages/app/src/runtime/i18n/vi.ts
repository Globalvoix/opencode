export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Thinksoft",
  ...
  "desktop.recovery.loadFailed": "Không tải được Thinksoft",
  "desktop.recovery.terminated": "Cửa sổ Thinksoft đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Thinksoft không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được Thinksoft",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Thinksoft nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Thinksoft cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Thinksoft.",
  ...
  "dialog.server.description": "Chuyển máy chủ Thinksoft mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra Thinksoft trong {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật Thinksoft trong {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật Thinksoft trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt Thinksoft trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Thinksoft có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Thinksoft.",
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Thinksoft ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Thinksoft",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Thinksoft chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Thinksoft bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Thinksoft",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Thinksoft trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Thinksoft tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Thinksoft.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Thinksoft khởi chạy",
  ...
  "settings.updates.action.download": "Tải Thinksoft xuống",
  "settings.updates.migration.title": "Chuyển từ Beta sang bản ổn định",
  "settings.updates.migration.description":
    "Hiện tại, Thinksoft Beta đang chuyển sang Thinksoft ổn định. Hãy tải phiên bản {{version}} xuống, sau đó cài đặt Thinksoft từ ảnh đĩa để tiếp tục nhận bản cập nhật.",
  "settings.updates.action.installing": "Đang cài đặt…",
  "settings.updates.toast.latest.title": "Đã cập nhật",
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Thinksoft.",
  ...
  "server.row.incompatible":
    "Máy chủ này đang chạy Thinksoft {{version}}, không tương thích với ứng dụng này. Hãy nâng cấp lên Thinksoft V2 để tiếp tục.",
  ...
  "session.error.incompatible.description":
    "{{server}} đang chạy Thinksoft {{version}}, không tương thích với ứng dụng này. Hãy nâng cấp máy chủ lên Thinksoft V2 để tiếp tục.",
  ...
  "settings.about.description": "Thinksoft, tác nhân mã hóa nguồn mở",
  ...
  "ssh.stage.checking": "Đang kiểm tra Thinksoft…",
  "ssh.stage.downloading": "Đang tải máy chủ xuống…",
  "ssh.stage.uploading": "Đang tải máy chủ lên…",
  "ssh.stage.starting": "Đang kết nối với Thinksoft…",
  ...
  "ssh.error.service": "Đã kết nối SSH, nhưng máy chủ Thinksoft chưa sẵn sàng.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Đây không phải mã ghép cặp Thinksoft. Quét mã được hiển thị bởi ghép cặp opencode.",
  ...
  "project.settings.name.description": "Tên hiển thị cho dự án này trên toàn Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "Các MCP có sẵn cho Thinksoft sẽ xuất hiện ở đây",
  "project.settings.extensions.empty.plugins.title": "Chưa có plugin nào",
  "project.settings.extensions.empty.plugins.description": "Các plugin có sẵn cho Thinksoft sẽ xuất hiện ở đây",
  "project.settings.extensions.empty.skills.title": "Chưa có kỹ năng nào",
  "project.settings.extensions.empty.skills.description": "Các kỹ năng có sẵn cho Thinksoft sẽ xuất hiện ở đây",
  ...
  "settings.workspaces.empty.description": "Các worktree được tạo trong Thinksoft sẽ xuất hiện ở đây",
