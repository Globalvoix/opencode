export const dict = {
  ...
  "desktop.menu.documentation": "Thinksoft दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "Thinksoft मेन्यू",
  ...
  "desktop.recovery.loadFailed": "Thinksoft लोड नहीं हो सका",
  "desktop.recovery.terminated": "Thinksoft विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "Thinksoft प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoft इंस्टॉल नहीं हो सका",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} में Thinksoft इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "Thinksoft अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "dialog.model.unpaid.freeModels.title": "Thinksoft द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और Thinksoft में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और Thinksoft में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा Thinksoft में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस Thinksoft सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingOpencode": "Thinksoft की जाँच हो रही है…",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} में Thinksoft की जाँच हो रही है…",
  "wsl.onboarding.updatingOpencode": "Thinksoft अपडेट हो रहा है…",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} में Thinksoft अपडेट हो रहा है…",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} में Thinksoft को अपडेट करें।",
  "wsl.onboarding.updateOpencode": "Thinksoft को अपडेट करें",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft {{distro}} में तैयार है।",
  "wsl.onboarding.opencodeReady": "Thinksoft तैयार है।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} में Thinksoft स्थापित करें।",
  "wsl.onboarding.installOpencode": "Thinksoft स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Thinksoft द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर Thinksoft को फिर से खोलें।",
  ...
  "toast.update.description": "Thinksoft ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट Thinksoft टीम को करें",
  ...
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, Thinksoft अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर Thinksoft सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "Thinksoft के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि Thinksoft आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि Thinksoft सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि Thinksoft की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "Thinksoft लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप Thinksoft का नवीनतम संस्करण चला रहे हैं।",
  ...
  "server.row.incompatible":
    "यह सर्वर Thinksoft {{version}} चला रहा है, जो इस ऐप के साथ संगत नहीं है। जारी रखने के लिए इसे Thinksoft V2 में अपग्रेड करें।",
  ...
  "session.error.incompatible.description":
    "{{server}} पर Thinksoft {{version}} चल रहा है, जो इस ऐप के साथ संगत नहीं है। जारी रखने के लिए सर्वर को Thinksoft V2 में अपग्रेड करें।",
  ...
  "settings.about.description": "Thinksoft, ओपन-सोर्स कोडिंग एजेंट",
  ...
  "ssh.stage.checking": "Thinksoft की जाँच हो रही है...",
  "ssh.stage.downloading": "सर्वर डाउनलोड हो रहा है...",
  "ssh.stage.uploading": "सर्वर अपलोड हो रहा है...",
  "ssh.stage.starting": "Thinksoft से कनेक्ट हो रहा है...",
  ...
  "ssh.error.service": "SSH कनेक्ट हो गया, लेकिन Thinksoft सर्वर तैयार नहीं हुआ।",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "यह कोई Thinksoft युग्मन कोड नहीं है. ओपनकोड जोड़ी द्वारा दिखाए गए कोड को स्कैन करें।",
  ...
  "project.settings.name.description": "इस प्रोजेक्ट के लिए पूरे Thinksoft में दिखाया गया नाम",
  ...
  "project.settings.extensions.empty.mcps.description": "Thinksoft के लिए उपलब्ध एमसीपी यहां दिखाई देंगे",
  "project.settings.extensions.empty.plugins.title": "अभी तक कोई प्लगइन्स नहीं",
  "project.settings.extensions.empty.plugins.description": "Thinksoft के लिए उपलब्ध प्लगइन्स यहां दिखाई देंगे",
  "project.settings.extensions.empty.skills.title": "अभी तक कोई कौशल नहीं है",
  "project.settings.extensions.empty.skills.description": "Thinksoft के लिए उपलब्ध कौशल यहां दिखाई देंगे",
  ...
  "settings.workspaces.empty.description": "Thinksoft में बनाए गए वर्कट्री यहां दिखाई देंगे",
  ...
  "settings.updates.action.download": "Thinksoft डाउनलोड करें",
  "settings.updates.migration.title": "बीटा से स्टेबल पर जाएँ",
  "settings.updates.migration.description":
    "फ़िलहाल Thinksoft Beta को Thinksoft Stable में बदला जा रहा है। संस्करण {{version}} डाउनलोड करें, फिर अपडेट मिलते रहने के लिए डिस्क इमेज से Thinksoft इंस्टॉल करें।",
}
