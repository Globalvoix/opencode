export const dict = {
  ...
  "desktop.menu.documentation": "Thinksoft دستاویزات",
  ...
  "desktop.menu.ariaLabel": "Thinksoft مینو",
  ...
  "desktop.recovery.loadFailed": "Thinksoft لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "Thinksoft ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "Thinksoft جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoft کی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "\u2068{{distro}}\u2069 میں Thinksoft انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "Thinksoft کی اپ ڈیٹ مکمل ہو گئی لیکن \u2068{{distro}}\u2069 اب بھی \u2068{{installed}}\u2069 کی اطلاع دے رہا ہے؛ متوقع ورژن \u2068{{expected}}\u2069 ہے",
  ...
  "dialog.model.unpaid.freeModels.title": "Thinksoft کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Thinksoft میں \u2068{{provider}}\u2069 ماڈلز استعمال کرنے کے لیے اپنی \u2068{{provider}}\u2069 API کلید درج کریں۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Thinksoft میں \u2068{{provider}}\u2069 ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Thinksoft میں \u2068{{provider}}\u2069 ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Thinksoft سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "Thinksoft چیک کیا جا رہا ہے…",
  "wsl.onboarding.checkingOpencodeIn": "\u2068{{distro}}\u2069 میں Thinksoft چیک کیا جا رہا ہے…",
  "wsl.onboarding.updatingOpencode": "Thinksoft کو اپ ڈیٹ کیا جا رہا ہے…",
  "wsl.onboarding.updatingOpencodeIn": "\u2068{{distro}}\u2069 میں Thinksoft کو اپ ڈیٹ کیا جا رہا ہے…",
  "wsl.onboarding.updateOpencodeIn": "\u2068{{distro}}\u2069 میں Thinksoft کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "Thinksoft کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft \u2068{{distro}}\u2069 میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "Thinksoft تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "\u2068{{distro}}\u2069 میں Thinksoft انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "Thinksoft انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Thinksoft WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Thinksoft کو دوبارہ کھولیں۔",
  ...
  "toast.update.description": "Thinksoft (\u2068{{version}}\u2069) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم Thinksoft ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed":
    'MCP سرور "\u2068{{name}}\u2069" ناکام ہو گیا۔ نوٹ، Thinksoft ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "Thinksoft ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Thinksoft سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "Thinksoft کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Thinksoft کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا Thinksoft سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Thinksoft کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "Thinksoft لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ Thinksoft کا تازہ ترین ورژن چلا رہے ہیں۔",
  ...
  "server.row.incompatible":
    "یہ سرور Thinksoft \u2068{{version}}\u2069 چلا رہا ہے، جو اس ایپ کے ساتھ مطابقت نہیں رکھتا۔ جاری رکھنے کے لیے اسے Thinksoft V2 پر اپ گریڈ کریں۔",
  ...
  "session.error.incompatible.description":
    "\u2068{{server}}\u2069 پر Thinksoft \u2068{{version}}\u2069 چل رہا ہے، جو اس ایپ کے ساتھ مطابقت نہیں رکھتا۔ جاری رکھنے کے لیے سرور کو Thinksoft V2 پر اپ گریڈ کریں۔",
  ...
  "settings.about.description": "Thinksoft، اوپن سورس کوڈنگ ایجنٹ",
  ...
  "ssh.stage.checking": "چیک کیا جا رہا ہے Thinksoft…",
  "ssh.stage.downloading": "سرور ڈاؤن لوڈ ہو رہا ہے…",
  "ssh.stage.uploading": "سرور اپ لوڈ ہو رہا ہے…",
  "ssh.stage.starting": "Thinksoft سے منسلک ہو رہا ہے…",
  ...
  "ssh.error.service": "SSH منسلک، لیکن Thinksoft سرور تیار نہیں ہوا۔",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid":
    "یہ Thinksoft جوڑا بنانے والا کوڈ نہیں ہے۔ اوپن کوڈ جوڑی کے ذریعہ دکھائے گئے کوڈ کو اسکین کریں۔",
  ...
  "project.settings.name.description": "پورے Thinksoft میں اس پروجیکٹ کے لیے دکھایا گیا نام",
  ...
  "project.settings.extensions.empty.mcps.description": "Thinksoft کو دستیاب MCPs یہاں ظاہر ہوں گے۔",
  "project.settings.extensions.empty.plugins.title": "ابھی تک کوئی پلگ ان نہیں ہے۔",
  "project.settings.extensions.empty.plugins.description": "Thinksoft کے لیے دستیاب پلگ انز یہاں ظاہر ہوں گے۔",
  "project.settings.extensions.empty.skills.title": "ابھی تک کوئی ہنر نہیں ہے۔",
  "project.settings.extensions.empty.skills.description": "Thinksoft کو دستیاب مہارتیں یہاں ظاہر ہوں گی۔",
  ...
  "settings.workspaces.empty.description": "Thinksoft میں بنائے گئے ورک ٹریس یہاں ظاہر ہوں گے۔",
  ...
  "settings.updates.action.download": "Thinksoft ڈاؤن لوڈ کریں",
  "settings.updates.migration.title": "بیٹا سے مستحکم ورژن پر جائیں",
  "settings.updates.migration.description":
    "فی الحال Thinksoft Beta کو Thinksoft Stable میں منتقل کیا جا رہا ہے۔ ورژن \u2068{{version}}\u2069 ڈاؤن لوڈ کریں، پھر اپ ڈیٹس ملتے رہنے کے لیے ڈسک امیج سے Thinksoft انسٹال کریں۔",
}
