...
export const dict = {
  ...
  "ssh.stage.checking": "Checking Thinksoft…",
  "ssh.stage.downloading": "Downloading server…",
  "ssh.stage.uploading": "Uploading server…",
  "ssh.stage.starting": "Connecting to Thinksoft…",
  ...
  "ssh.error.service": "SSH connected, but the Thinksoft server did not become ready.",
  "ssh.error.host-key":
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Thinksoft",
  ...
  "provider.connect.remote.description":
    "Your Thinksoft credentials will be stored on this server. Models will be available through this server.",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Thinksoft.",
  ...
  "dialog.server.description": "Switch which Thinksoft server this app connects to.",
  ...
  "server.connect.scan.invalid": "This is not a Thinksoft pairing code. Scan the code shown by opencode pair.",
  ...
  "pair.screenActive.description": "Prevent this computer’s display from sleeping while Thinksoft is running.",
  "pair.screenActive.error": "Could not update the screen activity setting. Try again.",
  "pair.description": "Connect another device to this machine's Thinksoft server.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Checking Thinksoft in {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Updating Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Updating Thinksoft in {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Update Thinksoft in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Thinksoft in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Thinksoft can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Thinksoft.",
  ...
  "server.row.incompatible":
    "This server is running Thinksoft {{version}}, which isn't compatible with this app. Upgrade it to Thinksoft V2 to continue.",
  ...
  "toast.update.description": "A new version of Thinksoft ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Thinksoft team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Thinksoft does not support MCP authentication yet.',
  ...
  "home.title": "Home",
  "newSession.heading": "What should we build?",
  ...
  "session.error.incompatible.description":
    "{{server}} is running Thinksoft {{version}}, which isn't compatible with this app. Upgrade the server to Thinksoft V2 to continue.",
  ...
  "sidebar.gettingStarted.line1": "Thinksoft includes free models so you can start immediately.",
  ...
  "settings.about.description": "Thinksoft, the open source coding agent",
  ...
  "settings.desktop.wsl.description": "Run the Thinksoft server inside WSL on Windows.",
  ...
  "project.settings.name.description": "The name shown for this project throughout Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs available to Thinksoft will appear here",
  "project.settings.extensions.empty.plugins.title": "No plugins yet",
  "project.settings.extensions.empty.plugins.description": "Plugins available to Thinksoft will appear here",
  "project.settings.extensions.empty.skills.title": "No skills yet",
  "project.settings.extensions.empty.skills.description": "Skills available to Thinksoft will appear here",
  ...
  "settings.general.row.language.description": "Change the display language for Thinksoft",
  ...
  "settings.general.row.appearance.description": "Customise how Thinksoft looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Thinksoft follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Thinksoft is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Thinksoft launches",
  ...
  "settings.updates.action.download": "Download Thinksoft",
  "settings.updates.migration.title": "Move from Beta to Stable",
  "settings.updates.migration.description":
    "For now, Thinksoft Beta is moving to Thinksoft Stable. Download version {{version}}, then install Thinksoft from the disk image to continue receiving updates.",
  "settings.updates.action.installing": "Installing…",
  "settings.updates.toast.latest.title": "You're up to date",
  "settings.updates.toast.latest.description": "You're running the latest version of Thinksoft.",
  ...
  "settings.workspaces.empty.description": "Worktrees created in Thinksoft will appear here",
