export const dict = {
  ...
  "ssh.stage.checking": "Tjekker Thinksoft...",
  "ssh.stage.downloading": "Downloader server...",
  "ssh.stage.uploading": "Uploader server...",
  "ssh.stage.starting": "Opretter forbindelse til Thinksoft...",
  ...
  "ssh.error.service": "SSH tilsluttet, men Thinksoft-serveren blev ikke klar.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Dette er ikke en Thinksoft-parringskode. Scan koden vist af opencode pair.",
  ...
  "project.settings.name.description": "Navnet vist for dette projekt i hele Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs tilgængelig for Thinksoft vises her",
  "project.settings.extensions.empty.plugins.title": "Ingen plugins endnu",
  "project.settings.extensions.empty.plugins.description": "Plugins, der er tilgængelige for Thinksoft, vises her",
  "project.settings.extensions.empty.skills.title": "Ingen færdigheder endnu",
  "project.settings.extensions.empty.skills.description": "De færdigheder, der er tilgængelige for Thinksoft, vises her",
  ...
  "settings.workspaces.empty.description": "Arbejdstræer oprettet i Thinksoft vises her",
  ...
  "settings.about.description": "Thinksoft, open source-kodningsagenten",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Thinksoft.",
  ...
  "dialog.server.description": "Skift hvilken Thinksoft-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Thinksoft i {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Opdaterer Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Thinksoft i {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Opdater Thinksoft i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Thinksoft kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Thinksoft igen.",
  ...
  "toast.update.description": "En ny version af Thinksoft ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Thinksoft-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Thinksoft understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Thinksoft-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Thinksoft",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Thinksoft ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Thinksoft skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Thinksofts tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Thinksoft starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Thinksoft.",
  ...
  "desktop.recovery.loadFailed": "Thinksoft kunne ikke indlæses",
  "desktop.recovery.terminated": "Thinksoft-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Thinksoft mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Thinksoft er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "server.row.incompatible":
    "Denne server kører Thinksoft {{version}}, som ikke er kompatibel med denne app. Opgrader den til Thinksoft V2 for at fortsætte.",
  ...
  "session.error.incompatible.description":
    "{{server}} kører Thinksoft {{version}}, som ikke er kompatibel med denne app. Opgrader serveren til Thinksoft V2 for at fortsætte.",
  ...
  "settings.updates.action.download": "Hent Thinksoft",
  "settings.updates.migration.title": "Skift fra Beta til Stabil",
  "settings.updates.migration.description":
    "Thinksoft Beta flyttes indtil videre til Thinksoft Stabil. Download version {{version}}, og installer derefter Thinksoft fra diskaftrykket for fortsat at modtage opdateringer.",
}
