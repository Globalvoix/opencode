export const dict = {
  ...
  "desktop.menu.documentation": "Thinksoft Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Thinksoft",
  ...
  "desktop.recovery.loadFailed": "Thinksoft se nepodařilo načíst",
  "desktop.recovery.terminated": "Thinksoft okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Thinksoft nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoft instalace se nezdařila",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Thinksoft aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Thinksoft.",
  ...
  "dialog.server.description": "Přepněte, ke kterému Thinksoft serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola Thinksoft v {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Aktualizace Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace Thinksoft v {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace Thinksoft v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte Thinksoft do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Thinksoft může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Thinksoft.",
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Thinksoft ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Thinksoft",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Thinksoft zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Thinksoft uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Thinksoft",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Thinksoft na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Thinksoft následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Thinksoft.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Thinksoft",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Thinksoft.",
  ...
  "server.row.incompatible":
    "Tento server používá Thinksoft {{version}}, který není kompatibilní s touto aplikací. Chcete-li pokračovat, upgradujte jej na Thinksoft V2.",
  ...
  "session.error.incompatible.description":
    "{{server}} používá Thinksoft {{version}}, který není kompatibilní s touto aplikací. Chcete-li pokračovat, upgradujte server na Thinksoft V2.",
  ...
  "settings.about.description": "Thinksoft, open source kódovací agent",
  ...
  "ssh.stage.checking": "Kontrola Thinksoft…",
  "ssh.stage.downloading": "Stahování serveru…",
  "ssh.stage.uploading": "Nahrávání serveru…",
  "ssh.stage.starting": "Připojování k Thinksoft…",
  ...
  "ssh.error.service": "SSH se připojilo, ale server Thinksoft nebyl připraven.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Toto není párovací kód Thinksoft. Naskenujte kód zobrazený příkazem opencode pair.",
  ...
  "project.settings.name.description": "Název zobrazovaný pro tento projekt v celém Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "Zde se zobrazí MCP dostupná pro Thinksoft",
  "project.settings.extensions.empty.plugins.title": "Zatím žádné zásuvné moduly",
  "project.settings.extensions.empty.plugins.description": "Zde se zobrazí zásuvné moduly dostupné pro Thinksoft",
  "project.settings.extensions.empty.skills.title": "Zatím žádné dovednosti",
  "project.settings.extensions.empty.skills.description": "Zde se zobrazí dovednosti dostupné pro Thinksoft",
  ...
  "settings.workspaces.empty.description": "Zde se zobrazí pracovní stromy vytvořené v Thinksoft",
  ...
  "settings.updates.action.download": "Stáhnout Thinksoft",
  "settings.updates.migration.title": "Přejít z Beta na Stable",
  "settings.updates.migration.description":
    "Thinksoft Beta prozatím přechází na Thinksoft Stable. Stáhněte verzi {{version}} a poté nainstalujte Thinksoft z obrazu disku, abyste mohli nadále dostávat aktualizace.",
