export const dict = {
  ...
  "ssh.error.service": "SSH si è connesso, ma il server Thinksoft non è pronto.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid":
    "Questo non è un codice di abbinamento Thinksoft. Scansiona il codice mostrato da opencode pair.",
  ...
  "project.settings.name.description": "Il nome mostrato per questo progetto in tutto Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs disponibile per Thinksoft verrà visualizzato qui",
  "project.settings.extensions.empty.plugins.title": "Nessun plugin ancora",
  "project.settings.extensions.empty.plugins.description": "I plugin disponibili per Thinksoft appariranno qui",
  "project.settings.extensions.empty.skills.title": "Nessuna competenza ancora",
  "project.settings.extensions.empty.skills.description": "Le abilità disponibili per Thinksoft appariranno qui",
  ...
  "settings.workspaces.empty.description": "Gli spazi di lavoro creati in Thinksoft appariranno qui",
  ...
  "settings.about.description": "Thinksoft, l’agente di programmazione open source",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Thinksoft.",
  ...
  "dialog.server.description": "Cambia il server Thinksoft a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Thinksoft in {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Thinksoft in {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Thinksoft in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Thinksoft in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Thinksoft possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Thinksoft.",
  ...
  "toast.update.description": "Una nuova versione di Thinksoft ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Thinksoft",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Thinksoft non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Thinksoft all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Thinksoft",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Thinksoft sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Thinksoft segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Thinksoft.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Thinksoft",
  ...
  "settings.updates.toast.latest.title": "Thinksoft è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Thinksoft.",
  ...
  "desktop.menu.documentation": "Documentazione di Thinksoft",
  ...
  "desktop.menu.ariaLabel": "Menu Thinksoft",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Thinksoft",
  "desktop.recovery.terminated": "La finestra di Thinksoft si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Thinksoft non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Thinksoft non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Thinksoft è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
  ...
  "server.row.incompatible":
    "Questo server esegue Thinksoft {{version}}, che non è compatibile con questa applicazione. Aggiornalo a Thinksoft V2 per continuare.",
  ...
  "session.error.incompatible.description":
    "{{server}} esegue Thinksoft {{version}}, che non è compatibile con questa applicazione. Aggiorna il server a Thinksoft V2 per continuare.",
  ...
  "settings.updates.action.download": "Scarica Thinksoft",
  "settings.updates.migration.title": "Passa da Beta a Stabile",
  "settings.updates.migration.description":
    "Per il momento, Thinksoft Beta sta passando a Thinksoft Stabile. Scarica la versione {{version}}, quindi installa Thinksoft dall’immagine disco per continuare a ricevere gli aggiornamenti.",
}
