export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Thinksoft",
  ...
  "desktop.recovery.loadFailed": "Thinksoft gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Thinksoft ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Thinksoft tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Thinksoft gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Thinksoft selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Thinksoft.",
  ...
  "dialog.server.description": "Tukar pelayan Thinksoft yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Thinksoft dalam {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Thinksoft dalam {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Thinksoft dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Thinksoft dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Thinksoft boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Thinksoft.",
  ...
  "toast.update.description": "Versi baharu Thinksoft ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Thinksoft",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Thinksoft belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Thinksoft dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Thinksoft",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Thinksoft pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Thinksoft mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Thinksoft.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Thinksoft dilancarkan",
  ...
  "settings.updates.action.download": "Muat turun Thinksoft",
  "settings.updates.migration.title": "Beralih daripada Beta kepada Stabil",
  "settings.updates.migration.description":
    "Buat masa ini, Thinksoft Beta sedang beralih kepada Thinksoft Stabil. Muat turun versi {{version}}, kemudian pasang Thinksoft daripada imej cakera untuk terus menerima kemas kini.",
  "settings.updates.action.installing": "Sedang memasang…",
  "settings.updates.toast.latest.title": "Anda sudah terkini",
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Thinksoft.",
  ...
  "server.row.incompatible":
    "Pelayan ini menjalankan Thinksoft {{version}}, yang tidak serasi dengan aplikasi ini. Tingkatkan kepada Thinksoft V2 untuk meneruskan.",
  ...
  "session.error.incompatible.description":
    "{{server}} menjalankan Thinksoft {{version}}, yang tidak serasi dengan aplikasi ini. Tingkatkan pelayan kepada Thinksoft V2 untuk meneruskan.",
  ...
  "settings.about.description": "Thinksoft, ejen pengekodan sumber terbuka",
  ...
  "ssh.stage.checking": "Memeriksa Thinksoft…",
  "ssh.stage.downloading": "Muat turun pelayan…",
  "ssh.stage.uploading": "Muat naik pelayan…",
  "ssh.stage.starting": "Menyambung ke Thinksoft…",
  ...
  "ssh.error.service": "SSH bersambung, tetapi pelayan Thinksoft tidak bersedia.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Ini bukan kod pasangan Thinksoft. Imbas kod yang ditunjukkan oleh pasangan opencode.",
  ...
  "project.settings.name.description": "Nama yang ditunjukkan untuk projek ini di seluruh Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCP yang tersedia untuk Thinksoft akan muncul di sini",
  "project.settings.extensions.empty.plugins.title": "Tiada plugin lagi",
  "project.settings.extensions.empty.plugins.description": "Plugin yang tersedia untuk Thinksoft akan muncul di sini",
  "project.settings.extensions.empty.skills.title": "Tiada kemahiran lagi",
  "project.settings.extensions.empty.skills.description": "Kemahiran yang tersedia untuk Thinksoft akan muncul di sini",
  ...
  "settings.workspaces.empty.description": "Worktree yang dibuat dalam Thinksoft akan muncul di sini",
