export const dict = {
  ...
  "desktop.menu.documentation": "Thinksoft Документација",
  ...
  "desktop.menu.ariaLabel": "Thinksoft мени",
  ...
  "desktop.recovery.loadFailed": "Thinksoft не успеа да се вчита",
  "desktop.recovery.terminated": "Прозорецот Thinksoft неочекувано заврши",
  "desktop.recovery.unresponsive": "Thinksoft не реагира",
  ...
  "desktop.wsl.error.installOpencode": "инсталацијата Thinksoft не успеа",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft не е инсталиран во {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Thinksoft ажурирањето е завршено, но {{distro}} сè уште известува {{installed}}; се очекува {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатни модели обезбедени од Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Внесете го вашиот клуч {{provider}} API за да ја поврзете вашата сметка и да користите {{provider}} модели во Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "да го соберете вашиот код за авторизација за да ја поврзете вашата сметка и да користите {{provider}} модели во Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и внесете го кодот подолу за да ја поврзете вашата сметка и да користите {{provider}} модели во Thinksoft.",
  ...
  "dialog.server.description": "Променете на кој Thinksoft сервер се поврзува оваа апликација.",
  ...
  "wsl.onboarding.checkingOpencode": "Се проверува Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Се проверува Thinksoft во {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Се ажурира Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Се ажурира Thinksoft во {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Ажурирајте Thinksoft во {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ажурирај Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft е подготвен во {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft е подготвен.",
  "wsl.onboarding.installOpencodeIn": "Инсталирајте Thinksoft во {{distro}}.",
  "wsl.onboarding.installOpencode": "Инсталирај Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft не е инсталиран",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) е потребно пред Thinksoft да може да додаде WSL сервер",
  "wsl.onboarding.wslUnavailable.title": "WSL недостапен",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft не можеше да го потврди WSL на оваа машина.",
  "wsl.onboarding.installWsl": "Инсталирај WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирајте го Windows за да завршите со инсталирањето WSL, а потоа повторно отворете Thinksoft.",
  ...
  "toast.update.description": "Новата верзија на Thinksoft ({{version}}) сега е достапна за инсталирање.",
  ...
  "error.page.report.prefix": "Ве молиме пријавете ја оваа грешка на тимот Thinksoft",
  ...
  "error.chain.mcpFailed":
    "MCP серверот „{{name}}“ не успеа. Забелешка, Thinksoft сè уште не поддржува автентикација MCP.",
  ...
  "sidebar.gettingStarted.line1": "Thinksoft вклучува бесплатни модели за да можете веднаш да започнете.",
  ...
  "settings.desktop.wsl.description": "Стартувај го серверот Thinksoft во WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете го јазикот на прикажување за Thinksoft",
  ...
  "settings.general.row.appearance.description": "Приспособете како изгледа Thinksoft на вашиот уред",
  "settings.general.row.colorScheme.title": "Шема на бои",
  "settings.general.row.colorScheme.description": "Изберете дали Thinksoft ја следи системската, светла или темна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Приспособете како Thinksoft е тематизирана.",
  ...
  "settings.updates.row.startup.description": "Автоматски проверувајте дали има ажурирања кога ќе се стартува Thinksoft",
  ...
  "settings.updates.toast.latest.description": "Ја извршувате најновата верзија на Thinksoft.",
  ...
  "server.row.incompatible":
    "Овој сервер користи Thinksoft {{version}}, кој не е компатибилен со апликацијава. Надградете го на Thinksoft V2 за да продолжите.",
  ...
  "session.error.incompatible.description":
    "{{server}} користи Thinksoft {{version}}, кој не е компатибилен со апликацијава. Надградете го серверот на Thinksoft V2 за да продолжите.",
  ...
  "settings.about.description": "Thinksoft, агент за кодирање со отворен код",
  ...
  "ssh.stage.checking": "Проверка на Thinksoft…",
  "ssh.stage.downloading": "Преземање на сервер…",
  "ssh.stage.uploading": "Серверот се поставува…",
  "ssh.stage.starting": "Се поврзува со Thinksoft…",
  ...
  "ssh.error.service": "SSH е поврзан, но серверот Thinksoft не стана подготвен.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Ова не е Thinksoft паринг код. Скенирајте го кодот прикажан од opencode pair.",
  ...
  "project.settings.name.description": "Името што се прикажува за овој проект низ Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs достапни за Thinksoft ќе се појават тука",
  "project.settings.extensions.empty.plugins.title": "Сè уште нема приклучоци",
  "project.settings.extensions.empty.plugins.description": "Приклучоци достапни за Thinksoft ќе се појават тука",
  "project.settings.extensions.empty.skills.title": "Сè уште нема вештини",
  "project.settings.extensions.empty.skills.description": "Вештини достапни за Thinksoft ќе се појават тука",
  ...
  "settings.workspaces.empty.description": "Worktrees креирани во Thinksoft ќе се прикажат тука",
  ...
  "settings.updates.action.download": "Преземи Thinksoft",
  "settings.updates.migration.title": "Премини од Beta на Stable",
  "settings.updates.migration.description":
    "Засега Thinksoft Beta преминува на Thinksoft Stable. Преземете ја верзијата {{version}}, а потоа инсталирајте го Thinksoft од сликата на дискот за да продолжите да добивате ажурирања.",
