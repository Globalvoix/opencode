...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Thinksoft se nije uspio učitati",
  "Prozor aplikacije Thinksoft neočekivano je zatvoren",
  "Thinksoft ne reagira",
  ...
  "Instalacija aplikacije Thinksoft nije uspjela",
  ...
  "Thinksoft nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Thinksoft je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Thinksoft.",
  ...
  "dialog.server.description": "Promijenite na koji se Thinksoft poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Thinksoft u {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Thinksoft u {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Thinksoft u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Thinksoft u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Thinksoft",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Thinksoft može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Thinksoft.",
  ...
  "toast.update.description": "Nova verzija Thinksoft ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Thinksoft timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Thinksoft još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Thinksoft Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Thinksoft poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Thinksoft",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Thinksoft izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Thinksoft slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Thinksoft tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Thinksoft pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Thinksoft.",
  ...
  "server.row.incompatible":
    "Ovaj poslužitelj koristi Thinksoft {{version}}, koji nije kompatibilan s ovom aplikacijom. Nadogradite ga na Thinksoft V2 kako biste nastavili.",
  ...
  "session.error.incompatible.description":
    "{{server}} koristi Thinksoft {{version}}, koji nije kompatibilan s ovom aplikacijom. Nadogradite poslužitelj na Thinksoft V2 kako biste nastavili.",
  ...
  "ssh.error.service": "SSH je povezan, ali Thinksoft poslužitelj nije postao spreman.",
  "ssh.error.host-key":
  ...
  "project.settings.name.description": "Naziv koji se prikazuje za ovaj projekt u cijelome Thinksoft-u",
  ...
  "settings.updates.migration.description":
    "Thinksoft Beta zasad prelazi na Thinksoft Stable. Preuzmite verziju {{version}}, a zatim instalirajte Thinksoft iz slike diska kako biste nastavili primati ažuriranja.",
