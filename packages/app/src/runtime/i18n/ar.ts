export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Thinksoft",
  "desktop.recovery.terminated": "توقفت نافذة Thinksoft بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Thinksoft لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Thinksoft",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Thinksoft، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Thinksoft.",
  ...
  "dialog.server.description": "تبديل خادم Thinksoft الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Thinksoft في {{distro}}…",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Thinksoft في {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "حدّث Thinksoft في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Thinksoft في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Thinksoft من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Thinksoft التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Thinksoft.",
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Thinksoft ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Thinksoft",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Thinksoft لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Thinksoft نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Thinksoft داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Thinksoft",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Thinksoft على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Thinksoft يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Thinksoft.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Thinksoft",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Thinksoft.",
  ...
  "server.row.incompatible":
    "يعمل هذا الخادم بإصدار Thinksoft \u2068{{version}}\u2069، وهو غير متوافق مع هذا التطبيق. رقِّه إلى Thinksoft V2 للمتابعة.",
  ...
  "session.error.incompatible.description":
    "يعمل \u2068{{server}}\u2069 بإصدار Thinksoft \u2068{{version}}\u2069، وهو غير متوافق مع هذا التطبيق. رقِّ الخادم إلى Thinksoft V2 للمتابعة.",
  ...
  "settings.about.description": "\u2068Thinksoft\u2069، وكيل البرمجة مفتوح المصدر",
  ...
  "ssh.stage.checking": "جارٍ التحقق من Thinksoft…",
  "ssh.stage.downloading": "جارٍ تنزيل الخادم…",
  "ssh.stage.uploading": "جارٍ رفع الخادم…",
  "ssh.stage.starting": "جارٍ الاتصال بـ Thinksoft…",
  ...
  "ssh.error.service": "اتصل SSH، لكن خادم Thinksoft لم يصبح جاهزًا.",
  ...
  "server.connect.scan.invalid": "هذا ليس رمز إقران Thinksoft. امسح الرمز الذي يعرضه opencode pair.",
  ...
  "project.settings.name.description": "الاسم المعروض لهذا المشروع في جميع أنحاء Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "ستظهر هنا خوادم MCP المتاحة لـ Thinksoft",
  "project.settings.extensions.empty.plugins.title": "لا توجد ملحقات بعد",
  "project.settings.extensions.empty.plugins.description": "ستظهر هنا الملحقات المتاحة لـ Thinksoft",
  "project.settings.extensions.empty.skills.title": "لا توجد مهارات بعد",
  "project.settings.extensions.empty.skills.description": "ستظهر هنا المهارات المتاحة لـ Thinksoft",
  ...
  "settings.workspaces.empty.description": "ستظهر هنا أشجار العمل المنشأة في Thinksoft",
  ...
  "settings.updates.action.download": "تنزيل Thinksoft",
  "settings.updates.migration.title": "الانتقال من الإصدار التجريبي إلى المستقر",
  "settings.updates.migration.description":
    "ينتقل Thinksoft Beta حاليًا إلى Thinksoft Stable. نزّل الإصدار \u2068{{version}}\u2069، ثم ثبّت Thinksoft من صورة القرص للاستمرار في تلقي التحديثات.",
}
