export const dict = {
  ...
  "desktop.recovery.loadFailed": "Thinksoft laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Thinksoft aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Thinksoft ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoft installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Thinksoft värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Thinksoft'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Thinksoft.",
  ...
  "dialog.server.description": "Lülitage, millise Thinksoft serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Thinksoft kontrollimine…",
  "wsl.onboarding.checkingOpencodeIn": "Thinksoft kontrollimine asukohas {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Thinksoft värskendamine…",
  "wsl.onboarding.updatingOpencodeIn": "Thinksoft värskendamine asukohas {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Thinksoft jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Thinksoft asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Thinksoft saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Thinksoft.",
  ...
  "toast.update.description": "Rakenduse Thinksoft ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Thinksoft meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Thinksoft ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Thinksoft Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Thinksoft server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Thinksoft kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Thinksoft teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Thinksoft järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Thinksoft on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Thinksoft käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Thinksoft uusimat versiooni.",
  ...
  "server.row.incompatible":
    "See server käitab Thinksoft'i versiooni {{version}}, mis ei ühildu selle rakendusega. Jätkamiseks uuenda server Thinksoft V2-le.",
  ...
  "session.error.incompatible.description":
    "{{server}} käitab Thinksoft'i versiooni {{version}}, mis ei ühildu selle rakendusega. Jätkamiseks uuenda server Thinksoft V2-le.",
  ...
  "settings.about.description": "Thinksoft, avatud lähtekoodiga kodeerimisagent",
  ...
  "ssh.stage.checking": "Thinksoft kontrollimine…",
  "ssh.stage.downloading": "Serveri allalaadimine…",
  "ssh.stage.uploading": "Serveri üleslaadimine…",
  "ssh.stage.starting": "Ühendamine seadmega Thinksoft…",
  ...
  "ssh.error.service": "SSH on ühendatud, kuid server Thinksoft ei saanud valmis.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "See ei ole Thinksoft sidumiskood. Skannige koodi, mida näitab opencode pair.",
  ...
  "project.settings.name.description": "Selle projekti jaoks kuvatud nimi kogu Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs, mis on saadaval Thinksoft jaoks, kuvatakse siin",
  "project.settings.extensions.empty.plugins.title": "Pluginaid pole veel",
  "project.settings.extensions.empty.plugins.description": "Thinksoft jaoks saadaolevad pistikprogrammid kuvatakse siin",
  "project.settings.extensions.empty.skills.title": "Oskusi veel pole",
  "project.settings.extensions.empty.skills.description": "Siin kuvatakse Thinksoft jaoks saadaolevad oskused",
  ...
  "settings.workspaces.empty.description": "Siin kuvatakse programmis Thinksoft loodud tööpuud",
  ...
  "settings.updates.action.download": "Laadi Thinksoft alla",
  "settings.updates.migration.title": "Liigu beetaversioonilt stabiilsele versioonile",
  "settings.updates.migration.description":
    "Praegu liigub Thinksoft Beta versioonile Thinksoft Stable. Laadi alla versioon {{version}} ja installi Thinksoft kettatõmmiselt, et jätkata uuenduste saamist.",
}
