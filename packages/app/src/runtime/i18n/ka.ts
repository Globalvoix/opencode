export const dict = {
  ...
  "desktop.menu.documentation": "Thinksoft დოკუმენტაცია",
  ...
  "desktop.menu.ariaLabel": "Thinksoft მენიუ",
  ...
  "desktop.recovery.loadFailed": "Thinksoft ვერ ჩაიტვირთა",
  "desktop.recovery.terminated": "Thinksoft ფანჯარა მოულოდნელად შეწყდა",
  "desktop.recovery.unresponsive": "Thinksoft არ პასუხობს",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoft ინსტალაცია ვერ მოხერხდა",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft არ არის დაინსტალირებული {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Thinksoft განახლება დასრულდა, მაგრამ {{distro}} კვლავ იუწყება {{installed}}; მოსალოდნელია {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "უფასო მოდელები მოწოდებულია Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "შეიყვანეთ თქვენი {{provider}} API გასაღები თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები Thinksoft-ში.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " შეაგროვეთ თქვენი ავტორიზაციის კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენოთ {{provider}} მოდელები Thinksoft-ში.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " და შეიყვანეთ ქვემოთ კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები Thinksoft-ში.",
  ...
  "dialog.server.description": "გადართეთ რომელ Thinksoft სერვერს უკავშირდება ეს აპი.",
  ...
  "wsl.onboarding.checkingOpencode": "შემოწმებულია Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "შემოწმებულია Thinksoft-ში {{distro}}…",
  "wsl.onboarding.updatingOpencode": "განახლება Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Thinksoft განახლება ხდება {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "განახლება Thinksoft {{distro}}-ში.",
  "wsl.onboarding.updateOpencode": "განახლება Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft მზად არის {{distro}}-ში.",
  "wsl.onboarding.opencodeReady": "Thinksoft მზად არის.",
  "wsl.onboarding.installOpencodeIn": "დააინსტალირეთ Thinksoft {{distro}}-ში.",
  "wsl.onboarding.installOpencode": "დააინსტალირეთ Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft არ არის დაინსტალირებული",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows ქვესისტემა Linux-ისთვის) საჭიროა, სანამ Thinksoft შეძლებს WSL სერვერის დამატებას",
  "wsl.onboarding.wslUnavailable.title": "WSL მიუწვდომელია",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft ვერ დაადასტურა WSL ამ მოწყობილობაზე.",
  "wsl.onboarding.installWsl": "დააინსტალირეთ WSL",
  "wsl.onboarding.windowsRestartRequired":
    "გადატვირთეთ Windows WSL-ის ინსტალაციის დასასრულებლად, შემდეგ ხელახლა გახსენით Thinksoft.",
  ...
  "toast.update.description": "Thinksoft-ის ({{version}}) ახალი ვერსია ახლა ხელმისაწვდომია დასაინსტალირებლად.",
  ...
  "error.page.report.prefix": "გთხოვთ, შეატყობინოთ ეს შეცდომა Thinksoft გუნდს",
  ...
  "error.chain.mcpFailed":
    'MCP სერვერი "{{name}}" ვერ მოხერხდა. შენიშვნა, Thinksoft ჯერ არ უჭერს მხარს MCP ავთენტიფიკაციას.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft მოიცავს უფასო მოდელებს, ასე რომ თქვენ შეგიძლიათ დაუყოვნებლივ დაიწყოთ.",
  ...
  "app.name.desktop": "Thinksoft სამუშაო მაგიდა",
  ...
  "settings.desktop.wsl.description": "გაუშვით Thinksoft სერვერი WSL-ში Windows-ზე.",
  ...
  "settings.general.row.language.description": "შეცვალეთ ჩვენების ენა Thinksoft",
  ...
  "settings.general.row.appearance.description": "მორგეთ, როგორ გამოიყურება Thinksoft თქვენს მოწყობილობაზე",
  "settings.general.row.colorScheme.title": "ფერთა სქემა",
  "settings.general.row.colorScheme.description": "აირჩიეთ, მიჰყვება თუ არა Thinksoft სისტემას, ღია თუ ბნელ თემას",
  "settings.general.row.theme.title": "თემა",
  "settings.general.row.theme.description": "მორგება, თუ როგორ არის Thinksoft თემატური.",
  ...
  "settings.updates.row.startup.description": "ავტომატურად შეამოწმეთ განახლებები, როდესაც Thinksoft გაშვება",
  ...
  "settings.updates.toast.latest.description": "თქვენ იყენებთ Thinksoft-ის უახლეს ვერსიას.",
  ...
  "server.row.incompatible":
    "ამ სერვერზე გაშვებულია Thinksoft {{version}}, რომელიც ამ აპთან თავსებადი არ არის. გასაგრძელებლად განაახლეთ Thinksoft V2-მდე.",
  ...
  "session.error.incompatible.description":
    "{{server}}-ზე გაშვებულია Thinksoft {{version}}, რომელიც ამ აპთან თავსებადი არ არის. გასაგრძელებლად განაახლეთ სერვერი Thinksoft V2-მდე.",
  ...
  "settings.about.description": "Thinksoft, ღია კოდის მქონე კოდირების აგენტი",
  ...
  "ssh.stage.checking": "Thinksoft-ის შემოწმება…",
  "ssh.stage.downloading": "სერვერის გადმოწერა…",
  "ssh.stage.uploading": "სერვერის ატვირთვა…",
  "ssh.stage.starting": "კავშირის დამყარება Thinksoft-თან…",
  ...
  "ssh.error.service": "SSH დაკავშირებულია, მაგრამ Thinksoft სერვერი მზად არ გამხდარა.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid":
    "ეს Thinksoft-ის დაწყვილების კოდი არ არის. დაასკანირეთ opencode pair-ის მიერ ნაჩვენები კოდი.",
  ...
  "project.settings.name.description": "ეს სახელწოდება გამოჩნდება ამ პროექტისთვის Thinksoft-ში",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs, რომლებიც ხელმისაწვდომია Thinksoft-ისთვის, გამოჩნდება აქ",
  "project.settings.extensions.empty.plugins.title": "ჯერ არ არის პლაგინები",
  "project.settings.extensions.empty.plugins.description": "Thinksoft-ისთვის ხელმისაწვდომი პლაგინები აქ გამოჩნდება",
  "project.settings.extensions.empty.skills.title": "ჯერ არ არის უნარები",
  "project.settings.extensions.empty.skills.description": "Thinksoft-ისთვის ხელმისაწვდომი უნარები აქ გამოჩნდება",
  ...
  "settings.workspaces.empty.description": "Thinksoft-ში შექმნილი სამუშაო ხეები გამოჩნდება აქ",
  ...
  "settings.updates.action.download": "Thinksoft-ის ჩამოტვირთვა",
  "settings.updates.migration.title": "Beta-დან Stable-ზე გადასვლა",
  "settings.updates.migration.description":
    "ამჟამად Thinksoft Beta გადადის Thinksoft Stable-ზე. ჩამოტვირთეთ ვერსია {{version}}, შემდეგ დააინსტალირეთ Thinksoft დისკის ასლიდან, რათა განახლებების მიღება განაგრძოთ.",
