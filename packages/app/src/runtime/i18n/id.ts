export const dict = {
  ...
  "desktop.recovery.loadFailed": "Thinksoft gagal dimuat",
  "desktop.recovery.terminated": "Jendela Thinksoft berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Thinksoft tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Thinksoft gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Thinksoft selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Thinksoft.",
  ...
  "dialog.server.description": "Ganti server Thinksoft mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Thinksoft di {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Memperbarui Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Thinksoft di {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Thinksoft di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Thinksoft di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Thinksoft dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Thinksoft.",
  ...
  "toast.update.description": "Versi baru Thinksoft ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Thinksoft",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Thinksoft belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Thinksoft di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Thinksoft",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Thinksoft di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Thinksoft mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Thinksoft diluncurkan",
  ...
  "settings.updates.action.download": "Unduh Thinksoft",
  "settings.updates.migration.title": "Beralih dari Beta ke Stabil",
  "settings.updates.migration.description":
    "Untuk saat ini, Thinksoft Beta sedang beralih ke Thinksoft Stabil. Unduh versi {{version}}, lalu instal Thinksoft dari citra diska agar terus menerima pembaruan.",
  "settings.updates.action.installing": "Menginstal…",
  "settings.updates.toast.latest.title": "Versi Anda sudah terbaru",
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Thinksoft.",
  ...
  "server.row.incompatible":
    "Server ini menjalankan Thinksoft {{version}}, yang tidak kompatibel dengan aplikasi ini. Tingkatkan ke Thinksoft V2 untuk melanjutkan.",
  ...
  "session.error.incompatible.description":
    "{{server}} menjalankan Thinksoft {{version}}, yang tidak kompatibel dengan aplikasi ini. Tingkatkan server ke Thinksoft V2 untuk melanjutkan.",
  ...
  "settings.about.description": "Thinksoft, agen pengkodean sumber terbuka",
  ...
  "ssh.stage.starting": "Menghubungkan ke Thinksoft…",
  ...
  "ssh.error.service": "SSH terhubung, tetapi server Thinksoft tidak siap.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Ini bukan kode pemasangan Thinksoft. Pindai kode yang ditampilkan oleh opencode pair.",
  ...
  "project.settings.name.description": "Nama yang ditampilkan untuk proyek ini di seluruh Thinksoft",
  ...
  "project.settings.extensions.empty.skills.description": "Keahlian yang tersedia untuk Thinksoft akan muncul di sini",
  ...
  "settings.workspaces.empty.description": "Worktree yang dibuat di Thinksoft akan muncul di sini",
