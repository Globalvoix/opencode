export const dict = {
  ...
  "desktop.menu.documentation": "Thinksoft Документация",
  ...
  "desktop.menu.ariaLabel": "Thinksoft меню",
  ...
  "desktop.recovery.loadFailed": "Thinksoft не успя да се зареди",
  "desktop.recovery.terminated": "Прозорецът Thinksoft приключи неочаквано",
  "desktop.recovery.unresponsive": "Thinksoft не отговаря",
  ...
  "desktop.wsl.error.installOpencode": "Инсталирането на Thinksoft е неуспешно",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft не е инсталиран в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Thinksoft актуализацията приключи, но {{distro}} все още съобщава {{installed}}; очаквано {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Безплатни модели, предоставени от Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Въведете своя {{provider}} API ключ, за да свържете акаунта си и да използвате {{provider}} модели в Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "за да вземете вашия код за оторизация, за да свържете акаунта си и да използвате {{provider}} модели в Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и въведете кода по-долу, за да свържете акаунта си и да използвате {{provider}} модели в Thinksoft.",
  ...
  "dialog.server.description": "Превключете към кой Thinksoft сървър се свързва това приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверява се Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Проверява се Thinksoft в {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Актуализиране на Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Актуализиране на Thinksoft в {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Актуализирайте Thinksoft в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Актуализация Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft е готов в {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft е готов.",
  "wsl.onboarding.installOpencodeIn": "Инсталирайте Thinksoft в {{distro}}.",
  "wsl.onboarding.installOpencode": "Инсталирайте Thinksoft",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) се изисква, преди Thinksoft да може да добави WSL сървър",
  "wsl.onboarding.wslUnavailable.title": "WSL не е наличен",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft не можа да провери WSL на тази машина.",
  "wsl.onboarding.installWsl": "Инсталирайте WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирайте Windows, за да завършите инсталирането на WSL, след което отворете отново Thinksoft.",
  ...
  "toast.update.description": "Вече е достъпна за инсталиране нова версия на Thinksoft ({{version}}).",
  ...
  "error.page.report.prefix": "Моля, докладвайте тази грешка на екипа на Thinksoft",
  ...
  "error.chain.mcpFailed":
    'MCP сървър "{{name}}" не успя. Имайте предвид, че Thinksoft все още не поддържа MCP удостоверяване.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft включва безплатни модели, така че можете да започнете веднага.",
  ...
  "settings.desktop.wsl.description": "Стартирайте сървъра Thinksoft вътре в WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете езика на дисплея за Thinksoft",
  ...
  "settings.general.row.appearance.description": "Персонализирайте как изглежда Thinksoft на вашето устройство",
  "settings.general.row.colorScheme.title": "Цветова схема",
  "settings.general.row.colorScheme.description": "Изберете дали Thinksoft следва системната, светла или тъмна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Персонализирайте как е тематично Thinksoft.",
  ...
  "settings.updates.row.startup.description": "Автоматично проверявайте за актуализации при стартиране на Thinksoft",
  ...
  "settings.updates.toast.latest.description": "Вие използвате най-новата версия на Thinksoft.",
  ...
  "server.row.incompatible":
    "Този сървър работи с Thinksoft {{version}}, който не е съвместим с приложението. Надстройте го до Thinksoft V2, за да продължите.",
  ...
  "session.error.incompatible.description":
    "{{server}} работи с Thinksoft {{version}}, който не е съвместим с приложението. Надстройте сървъра до Thinksoft V2, за да продължите.",
  ...
  "settings.about.description": "Thinksoft, агентът за кодиране с отворен код",
  ...
  "ssh.stage.starting": "Свързване с Thinksoft…",
  ...
  "ssh.error.service": "SSH връзката е установена, но сървърът на Thinksoft не е готов.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Това не е код за сдвояване с Thinksoft. Сканирайте кода, показан от opencode pair.",
  ...
  "project.settings.name.description": "Името, което се показва за този проект в Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "Наличните за Thinksoft MCP сървъри ще се показват тук",
  "project.settings.extensions.empty.plugins.title": "Все още няма добавки",
  "project.settings.extensions.empty.plugins.description": "Наличните за Thinksoft добавки ще се показват тук",
  "project.settings.extensions.empty.skills.title": "Все още няма умения",
  "project.settings.extensions.empty.skills.description": "Наличните за Thinksoft умения ще се показват тук",
  ...
  "settings.workspaces.empty.description": "Създадените в Thinksoft работни дървета ще се показват тук",
  ...
  "settings.updates.action.download": "Изтегляне на Thinksoft",
  "settings.updates.migration.title": "Преминаване от Beta към Stable",
  "settings.updates.migration.description":
    "Засега Thinksoft Beta преминава към Thinksoft Stable. Изтеглете версия {{version}}, след което инсталирайте Thinksoft от дисковия образ, за да продължите да получавате актуализации.",
