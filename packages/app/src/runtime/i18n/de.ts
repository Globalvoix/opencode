...
export const dict = {
  ...
  "ssh.stage.checking": "Überprüfung Thinksoft…",
  "ssh.stage.downloading": "Server wird heruntergeladen…",
  "ssh.stage.uploading": "Server wird hochgeladen…",
  "ssh.stage.starting": "Verbindung mit Thinksoft herstellen…",
  ...
  "ssh.error.service": "SSH ist verbunden, aber der Thinksoft-Server ist nicht bereit.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid":
    "Dies ist kein Thinksoft-Pairing-Code. Scannen Sie den von opencode pair angezeigten Code.",
  ...
  "project.settings.name.description": "Der für dieses Projekt durchgehend angezeigte Name Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs verfügbar für Thinksoft wird hier angezeigt",
  "project.settings.extensions.empty.plugins.title": "Noch keine Plugins",
  "project.settings.extensions.empty.plugins.description": "Für Thinksoft verfügbare Plugins werden hier angezeigt",
  ...
  "project.settings.extensions.empty.skills.description":
    "Hier werden die für Thinksoft verfügbaren Fähigkeiten angezeigt",
  ...
  "settings.workspaces.empty.description": "In Thinksoft erstellte Arbeitsbereiche werden hier angezeigt",
  ...
  "settings.about.description": "Thinksoft, der Open-Source-Coding-Agent",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Thinksoft zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Thinksoft zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Thinksoft zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Thinksoft-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Thinksoft wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Thinksoft in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Thinksoft wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Thinksoft in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Thinksoft in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Thinksoft aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Thinksoft ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Thinksoft in {{distro}}.",
  "wsl.onboarding.installOpencode": "Thinksoft installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Thinksoft einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Thinksoft erneut.",
  ...
  "toast.update.description": "Eine neue Version von Thinksoft ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Thinksoft-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Thinksoft unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Thinksoft mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Thinksoft enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Thinksoft Desktop",
  ...
  "settings.desktop.wsl.description": "Thinksoft-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Thinksoft ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Thinksoft auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Thinksoft dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Thinksoft anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Thinksoft automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Thinksoft ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Thinksoft wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Thinksoft konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Thinksoft-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Thinksoft reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoft-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Thinksoft-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "server.row.incompatible":
    "Auf diesem Server wird Thinksoft {{version}} ausgeführt, das mit dieser App nicht kompatibel ist. Aktualisieren Sie ihn auf Thinksoft V2, um fortzufahren.",
  ...
  "session.error.incompatible.description":
    "Auf {{server}} wird Thinksoft {{version}} ausgeführt, das mit dieser App nicht kompatibel ist. Aktualisieren Sie den Server auf Thinksoft V2, um fortzufahren.",
  ...
  "settings.updates.action.download": "Thinksoft herunterladen",
  "settings.updates.migration.title": "Von Beta zu Stabil wechseln",
  "settings.updates.migration.description":
    "Thinksoft Beta wird vorerst zu Thinksoft Stabil verschoben. Laden Sie Version {{version}} herunter und installieren Sie Thinksoft anschließend über das Disk-Image, um weiterhin Updates zu erhalten.",
