export const dict = {
  ...
  "desktop.recovery.loadFailed": "Thinksoft መጫን አልቻለም",
  "desktop.recovery.terminated": "Thinksoft መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "Thinksoft ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoftመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "Thinksoft ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በThinksoft",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በThinksoft ይጠቀሙ።",
  ...
  "provider.connect.opencodeZen.line1": "Thinksoft ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በThinksoft ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በThinksoft ይጠቀሙ።",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው Thinksoft አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Thinksoftን በ{{distro}} ውስጥ በመፈተሽ ላይ…",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ Thinksoft በ{{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "አዘምን Thinksoft በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "Thinksoft ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን Thinksoft በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoftአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) Thinksoft WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ Thinksoft።",
  ...
  "toast.update.description": "አዲሱ የThinksoft ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለThinksoft ቡድን ያሳውቁ",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ Thinksoft እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "Thinksoft ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የThinksoft አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለThinksoft",
  ...
  "settings.general.row.appearance.description": "Thinksoftበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "Thinksoft ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Thinksoft ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "Thinksoft ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የThinksoft እትም እያሄዱ ነው።",
  ...
  "server.row.incompatible":
    "ይህ አገልጋይ Thinksoft {{version}}ን እያስኬደ ነው፣ ይህም ከዚህ መተግበሪያ ጋር ተኳሃኝ አይደለም። ለመቀጠል ወደ Thinksoft V2 ያሻሽሉት።",
  ...
  "session.error.incompatible.description":
    "{{server}} Thinksoft {{version}}ን እያስኬደ ነው፣ ይህም ከዚህ መተግበሪያ ጋር ተኳሃኝ አይደለም። ለመቀጠል አገልጋዩን ወደ Thinksoft V2 ያሻሽሉት።",
  ...
  "settings.about.description": "Thinksoft፣ ክፍት ምንጭ የኮድ ወኪል",
  ...
  "ssh.stage.checking": "የThinksoft በመፈተሽ ላይ...",
  "ssh.stage.downloading": "አገልጋይ በማውረድ ላይ...",
  "ssh.stage.uploading": "አገልጋይን በመጫን ላይ...",
  "ssh.stage.starting": "ከThinksoft ጋር በመገናኘት ላይ...",
  ...
  "ssh.error.service": "SSH ተገናኝቷል፣ ነገር ግን የThinksoft አገልጋዩ ዝግጁ አልሆነም።",
  ...
  "server.connect.scan.invalid": "ይህ የThinksoft ማጣመሪያ ኮድ አይደለም። opencode pair የሚያሳየውን ኮድ ይቃኙ።",
  ...
  "project.settings.name.description": "በመላው Thinksoft ውስጥ ለዚህ ፕሮጀክት የሚታየው ስም",
  ...
  "project.settings.extensions.empty.mcps.description": "ለThinksoft የሚገኙ MCP-ዎች እዚህ ይታያሉ",
  "project.settings.extensions.empty.plugins.title": "እስካሁን ምንም ተሰኪዎች የሉም\nለThinksoft የሚገኙ",
  "project.settings.extensions.empty.plugins.description": "ለThinksoft የሚገኙ ተሰኪዎች እዚህ ይታያሉ",
  "project.settings.extensions.empty.skills.title": "እስካሁን ምንም ችሎታ የለም\nለThinksoft የሚገኙ",
  "project.settings.extensions.empty.skills.description": "ለThinksoft የሚገኙ ክህሎቶች እዚህ ይታያሉ",
  ...
  "settings.workspaces.empty.description": "በThinksoft የተፈጠሩ የሥራ ዛፎች እዚህ ይታያሉ",
  ...
  "settings.updates.action.download": "Thinksoftን አውርድ",
  "settings.updates.migration.title": "ከBeta ወደ Stable ይዛወሩ",
  "settings.updates.migration.description":
    "ለጊዜው Thinksoft Beta ወደ Thinksoft Stable እየተዛወረ ነው። ዝማኔዎችን መቀበልዎን ለመቀጠል ስሪት {{version}}ን ያውርዱ፣ ከዚያ Thinksoftን ከዲስክ ምስሉ ይጫኑ።",
