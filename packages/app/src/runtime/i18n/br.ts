export const dict = {
  ...
  "ssh.error.service": "SSH conectado, mas o servidor Thinksoft não ficou pronto.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid":
    "Este não é um código de emparelhamento Thinksoft. Digitalize o código mostrado por opencode pair.",
  ...
  "project.settings.name.description": "O nome mostrado para este projeto em Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs disponível para Thinksoft aparecerá aqui",
  "project.settings.extensions.empty.plugins.title": "Ainda não há plug-ins",
  "project.settings.extensions.empty.plugins.description": "Os plug-ins disponíveis para Thinksoft aparecerão aqui",
  "project.settings.extensions.empty.skills.title": "Nenhuma habilidade ainda",
  "project.settings.extensions.empty.skills.description": "As habilidades disponíveis para Thinksoft aparecerão aqui",
  ...
  "settings.workspaces.empty.description": "As espaços de trabalho criadas em Thinksoft aparecerão aqui",
  ...
  "settings.about.description": "Thinksoft, o agente de programação de código aberto",
  ...
  "desktop.menu.documentation": "Documentação do Thinksoft",
  ...
  "desktop.menu.ariaLabel": "Menu do Thinksoft",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Thinksoft",
  "desktop.recovery.terminated": "A janela do Thinksoft foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Thinksoft não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Thinksoft",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Thinksoft não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Thinksoft foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Thinksoft.",
  ...
  "dialog.server.description": "Trocar para qual servidor Thinksoft este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Thinksoft em {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Atualizando o Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Thinksoft em {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Thinksoft em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "O Thinksoft está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Thinksoft está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Thinksoft em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Thinksoft possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Thinksoft não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Thinksoft novamente.",
  ...
  "toast.update.description": "Uma nova versão do Thinksoft ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Thinksoft",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Thinksoft ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Thinksoft dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Thinksoft",
  ...
  "settings.general.row.appearance.description": "Personalize como o Thinksoft aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Thinksoft segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Thinksoft é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Thinksoft iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Thinksoft.",
  ...
  "server.row.incompatible":
    "Este servidor está executando o Thinksoft {{version}}, que não é compatível com este aplicativo. Atualize-o para o Thinksoft V2 para continuar.",
  ...
  "session.error.incompatible.description":
    "{{server}} está executando o Thinksoft {{version}}, que não é compatível com este aplicativo. Atualize o servidor para o Thinksoft V2 para continuar.",
  ...
  "settings.updates.action.download": "Baixar o Thinksoft",
  "settings.updates.migration.title": "Migrar da versão Beta para a Estável",
  "settings.updates.migration.description":
    "Por enquanto, o Thinksoft Beta está migrando para o Thinksoft Estável. Baixe a versão {{version}} e instale o Thinksoft pela imagem de disco para continuar recebendo atualizações.",
}
