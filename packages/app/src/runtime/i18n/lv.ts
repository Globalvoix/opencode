export const dict = {
  ...
  "desktop.menu.documentation": "Thinksoft dokumentācija",
  ...
  "desktop.menu.ariaLabel": "Thinksoft izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt Thinksoft",
  "desktop.recovery.terminated": "Thinksoft logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "Thinksoft neatbild",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoft instalēšana neizdevās",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Thinksoft atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus Thinksoft.",
  ...
  "dialog.server.description": "Mainiet, pie kura Thinksoft servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingOpencode": "Pārbaudu Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Pārbaudu Thinksoft distribūcijā {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Atjauninu Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Atjauninu Thinksoft distribūcijā {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Atjauniniet Thinksoft distribūcijā {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atjauniniet Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft ir gatavs.",
  "wsl.onboarding.installOpencodeIn": "Instalējiet Thinksoft distribūcijā {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalējiet Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms Thinksoft var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet Thinksoft no jauna.",
  ...
  "toast.update.description": "Pieejama jauna Thinksoft versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu Thinksoft komandai",
  ...
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, Thinksoft vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "Thinksoft darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist Thinksoft serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt Thinksoft saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā Thinksoft izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai Thinksoft sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet Thinksoft tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot Thinksoft",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko Thinksoft versiju.",
  ...
  "server.row.incompatible":
    "Šajā serverī darbojas Thinksoft {{version}}, kas nav saderīga ar šo lietotni. Lai turpinātu, jauniniet serveri uz Thinksoft V2.",
  ...
  "session.error.incompatible.description":
    "Serverī {{server}} darbojas Thinksoft {{version}}, kas nav saderīga ar šo lietotni. Lai turpinātu, jauniniet serveri uz Thinksoft V2.",
  ...
  "settings.about.description": "Thinksoft, atvērtā koda kodēšanas aģents",
  ...
  "ssh.error.service": "SSH ir izveidots savienojums, taču serveris Thinksoft nebija gatavs.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Šis nav kods Thinksoft savienošanai pārī. Skenējiet kodu, ko parāda opencode pair.",
  ...
  "project.settings.name.description": "Šī projekta nosaukums tiek rādīts visā Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs, kas pieejams Thinksoft, tiks parādīts šeit",
  "project.settings.extensions.empty.plugins.title": "Vēl nav spraudņu",
  "project.settings.extensions.empty.plugins.description": "Thinksoft pieejamie spraudņi parādīsies šeit",
  "project.settings.extensions.empty.skills.title": "Vēl nav prasmju",
  "project.settings.extensions.empty.skills.description": "Thinksoft pieejamās prasmes parādīsies šeit",
  ...
  "settings.workspaces.empty.description": "Šeit tiks parādīti Thinksoft izveidotie darba koki",
  ...
  "settings.updates.action.download": "Lejupielādēt Thinksoft",
  "settings.updates.migration.title": "Pāriet no Beta uz stabilo versiju",
  "settings.updates.migration.description":
    "Pagaidām Thinksoft Beta tiek pārcelta uz Thinksoft Stable. Lejupielādējiet versiju {{version}} un pēc tam instalējiet Thinksoft no diska attēla, lai turpinātu saņemt atjauninājumus.",
}
