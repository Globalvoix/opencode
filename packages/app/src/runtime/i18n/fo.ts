export const dict = {
  ...
  "desktop.menu.documentation": "Thinksoft Skjøl",
  ...
  "desktop.menu.ariaLabel": "Thinksoft valmynd",
  ...
  "desktop.recovery.loadFailed": "Thinksoft miseydnaðist at heinta",
  "desktop.recovery.terminated": "Thinksoft vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "Thinksoft svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoft uppsetingin miseydnaðist",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Thinksoft dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í Thinksoft.",
  ...
  "dialog.server.description": "Skift hvønn Thinksoft ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Kanna Thinksoft í {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Dagføring Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring Thinksoft í {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Dagfør Thinksoft í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft er klárt í {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set Thinksoft upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn Thinksoft kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani Thinksoft aftur.",
  ...
  "toast.update.description": "Ein nýggj útgáva av Thinksoft ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til Thinksoft toymið",
  ...
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, Thinksoft stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "Thinksoft Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr Thinksoft ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri Thinksoft",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu Thinksoft sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um Thinksoft fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu Thinksoft er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá Thinksoft byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av Thinksoft.",
  ...
  "server.row.incompatible":
    "Hesin ambætarin koyrir Thinksoft {{version}}, sum ikki samsvarar við hetta forritið. Dagfør hann til Thinksoft V2 fyri at halda fram.",
  ...
  "session.error.incompatible.description":
    "{{server}} koyrir Thinksoft {{version}}, sum ikki samsvarar við hetta forritið. Dagfør ambætaran til Thinksoft V2 fyri at halda fram.",
  ...
  "settings.about.description": "Thinksoft, opna keldukoduumboðnum",
  ...
  "ssh.error.service": "SSH varð knýtt, men Thinksoft ambætarin gjørdist ikki klárur.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Hetta er ikki ein Thinksoft paringarkoda. Skanna kotuna, sum opencode pair vísir.",
  ...
  "project.settings.name.description": "Navnið víst fyri hesa verkætlan í øllum Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs tøkt til Thinksoft kemur fram her",
  "project.settings.extensions.empty.plugins.title": "Einki tilskot enn",
  "project.settings.extensions.empty.plugins.description": "Plugins, sum eru tøk til Thinksoft, koma at síggjast her",
  "project.settings.extensions.empty.skills.title": "Ongin førleiki enn",
  "project.settings.extensions.empty.skills.description": "Førleikar, sum eru tøkir hjá Thinksoft, koma fram her",
  ...
  "settings.workspaces.empty.description": "Arbeiðstrø, sum eru stovnað í Thinksoft, koma at síggjast her",
  ...
  "settings.updates.action.download": "Tak Thinksoft niður",
  "settings.updates.migration.title": "Far úr Beta í Støðugt",
  "settings.updates.migration.description":
    "Í løtuni verður Thinksoft Beta flutt til Thinksoft Stable. Tak útgávu {{version}} niður og legg síðani Thinksoft inn úr diskmyndini fyri framhaldandi at fáa dagføringar.",
}
