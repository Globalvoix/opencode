export const dict = {
  ...
  "desktop.menu.documentation": "Thinksoft Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Thinksoft.",
  ...
  "desktop.recovery.loadFailed": "Thinksoft no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Thinksoft s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Thinksoft no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de Thinksoft ha fallat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Thinksoft actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Thinksoft.",
  ...
  "dialog.server.description": "Canvia a quin Thinksoft servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant Thinksoft a {{distro}}…",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant Thinksoft a {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Actualitza Thinksoft a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu Thinksoft a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Thinksoft pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Thinksoft.",
  ...
  "toast.update.description": "Una nova versió de Thinksoft ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Thinksoft.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Thinksoft encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "Thinksoft Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Thinksoft dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Thinksoft",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Thinksoft al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Thinksoft segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Thinksoft.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï Thinksoft.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Thinksoft.",
  ...
  "server.row.incompatible":
    "Aquest servidor executa Thinksoft {{version}}, que no és compatible amb aquesta aplicació. Actualitzeu-lo a Thinksoft V2 per continuar.",
  ...
  "session.error.incompatible.description":
    "{{server}} executa Thinksoft {{version}}, que no és compatible amb aquesta aplicació. Actualitzeu el servidor a Thinksoft V2 per continuar.",
  ...
  "settings.about.description": "Thinksoft, l'agent de codificació de codi obert",
  ...
  "ssh.error.service": "SSH s'ha connectat, però el servidor Thinksoft no està preparat.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid":
    "Aquest no és un codi d'aparellament Thinksoft. Escaneja el codi mostrat per opencode pair.",
  ...
  "project.settings.name.description": "El nom mostrat per a aquest projecte a tot Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs disponible per a Thinksoft apareixerà aquí",
  "project.settings.extensions.empty.plugins.title": "Encara no hi ha connectors",
  "project.settings.extensions.empty.plugins.description": "Els connectors disponibles per a Thinksoft apareixeran aquí",
  "project.settings.extensions.empty.skills.title": "Encara no hi ha habilitats",
  "project.settings.extensions.empty.skills.description": "Les habilitats disponibles per a Thinksoft apareixeran aquí",
  ...
  "settings.workspaces.empty.description": "Els arbres de treball creats a Thinksoft apareixeran aquí",
  ...
  "settings.updates.action.download": "Baixa l’Thinksoft",
  "settings.updates.migration.title": "Passa de Beta a Estable",
  "settings.updates.migration.description":
    "De moment, Thinksoft Beta passa a Thinksoft Estable. Baixeu la versió {{version}} i instal·leu l’Thinksoft des de la imatge de disc per continuar rebent actualitzacions.",
}
