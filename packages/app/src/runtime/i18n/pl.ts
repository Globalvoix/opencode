export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Thinksoft",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Thinksoft",
  "desktop.recovery.terminated": "Okno Thinksoft zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Thinksoft nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Thinksoft",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Thinksoft została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Thinksoft.",
  ...
  "dialog.server.description": "Przełącz serwer Thinksoft, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Thinksoft w dystrybucji {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Thinksoft w dystrybucji {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Thinksoft w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Thinksoft w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Thinksoft będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Thinksoft.",
  ...
  "toast.update.description": "Nowa wersja Thinksoft ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Thinksoft",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Thinksoft nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Thinksoft zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Thinksoft wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Thinksoft",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Thinksoft na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Thinksoft ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Thinksoft.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Thinksoft",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Thinksoft.",
  ...
  "server.row.incompatible":
    "Ten serwer korzysta z Thinksoft {{version}}, który jest niezgodny z tą aplikacją. Aby kontynuować, uaktualnij go do Thinksoft V2.",
  ...
  "session.error.incompatible.description":
    "Serwer {{server}} korzysta z Thinksoft {{version}}, który jest niezgodny z tą aplikacją. Aby kontynuować, uaktualnij serwer do Thinksoft V2.",
  ...
  "settings.about.description": "Thinksoft, agent kodujący typu open source",
  ...
  "ssh.stage.checking": "Sprawdzanie Thinksoft…",
  "ssh.stage.downloading": "Pobieranie serwera…",
  "ssh.stage.uploading": "Wgrywanie serwera…",
  "ssh.stage.starting": "Łączenie z Thinksoft…",
  ...
  "ssh.error.service": "SSH połączony, ale serwer Thinksoft nie stał się gotowy.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "To nie jest kod parowania Thinksoft. Zeskanuj kod pokazany przez sparowanie opencode.",
  ...
  "project.settings.name.description": "Nazwa wyświetlana dla tego projektu w całym Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCP dostępne dla Thinksoft pojawią się tutaj",
  "project.settings.extensions.empty.plugins.title": "Jeszcze brak wtyczek",
  "project.settings.extensions.empty.plugins.description": "Wtyczki dostępne dla Thinksoft pojawią się tutaj",
  "project.settings.extensions.empty.skills.title": "Jeszcze brak umiejętności",
  "project.settings.extensions.empty.skills.description": "Umiejętności dostępne dla Thinksoft pojawią się tutaj",
  ...
  "settings.workspaces.empty.description": "Drzewa pracy utworzone w Thinksoft pojawią się tutaj",
  ...
  "settings.updates.action.download": "Pobierz Thinksoft",
  "settings.updates.migration.title": "Przejdź z Beta na Stable",
  "settings.updates.migration.description":
    "Thinksoft Beta jest obecnie przenoszony do Thinksoft Stable. Pobierz wersję {{version}}, a następnie zainstaluj Thinksoft z obrazu dysku, aby nadal otrzymywać aktualizacje.",
