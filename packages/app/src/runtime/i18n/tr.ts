...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Thinksoft yüklenemedi",
  "desktop.recovery.terminated": "Thinksoft penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Thinksoft yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoft kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Thinksoft güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Thinksoft tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Thinksoft'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Thinksoft'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Thinksoft'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Thinksoft sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Thinksoft kontrol ediliyor…",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Thinksoft kontrol ediliyor…",
  "wsl.onboarding.updatingOpencode": "Thinksoft güncelleniyor…",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Thinksoft güncelleniyor…",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Thinksoft'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Thinksoft'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Thinksoft hazır.",
  "wsl.onboarding.opencodeReady": "Thinksoft hazır.",
  "wsl.onboarding.installOpencodeIn": "Thinksoft'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Thinksoft'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Thinksoft'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Thinksoft'u tekrar açın.",
  ...
  "toast.update.description": "Thinksoft'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Thinksoft ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Thinksoft henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Thinksoft Masaüstü",
  ...
  "settings.desktop.wsl.description": "Thinksoft sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Thinksoft'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Thinksoft'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Thinksoft'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Thinksoft'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Thinksoft başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Thinksoft'un en son sürümünü kullanıyorsunuz.",
  ...
  "server.row.incompatible":
    "Bu sunucu, bu uygulamayla uyumlu olmayan Thinksoft {{version}} sürümünü çalıştırıyor. Devam etmek için Thinksoft V2'ye yükseltin.",
  ...
  "session.error.incompatible.description":
    "{{server}}, bu uygulamayla uyumlu olmayan Thinksoft {{version}} sürümünü çalıştırıyor. Devam etmek için sunucuyu Thinksoft V2'ye yükseltin.",
  ...
  "settings.about.description": "Thinksoft, açık kaynak kodlama aracısı",
  ...
  "ssh.stage.checking": "Thinksoft kontrol ediliyor…",
  "ssh.stage.downloading": "Sunucu indiriliyor…",
  "ssh.stage.uploading": "Sunucu yükleniyor…",
  "ssh.stage.starting": "Thinksoft'ye bağlanılıyor…",
  ...
  "ssh.error.service": "SSH bağlandı ancak Thinksoft sunucusu hazır olmadı.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid":
    "Bu bir Thinksoft eşleştirme kodu değildir. opencode pair tarafından gösterilen kodu tarayın.",
  ...
  "project.settings.name.description": "Thinksoft genelinde bu proje için gösterilen ad",
  ...
  "project.settings.extensions.empty.mcps.description": "Thinksoft tarafından kullanılabilen MCPs burada görünecek",
  "project.settings.extensions.empty.plugins.title": "Henüz eklenti yok",
  "project.settings.extensions.empty.plugins.description": "Thinksoft'de kullanılabilen eklentiler burada görünecek",
  "project.settings.extensions.empty.skills.title": "Henüz beceri yok",
  "project.settings.extensions.empty.skills.description": "Thinksoft'nin kullanabileceği beceriler burada görünecek",
  ...
  "settings.workspaces.empty.description": "Thinksoft'de oluşturulan çalışma ağaçları burada görünecek",
  ...
  "settings.updates.action.download": "Thinksoft’u indir",
  "settings.updates.migration.title": "Beta’dan Kararlı’ya geç",
  "settings.updates.migration.description":
    "Thinksoft Beta şimdilik Thinksoft Stable’a taşınıyor. Güncellemeleri almaya devam etmek için {{version}} sürümünü indirin, ardından Thinksoft’u disk görüntüsünden yükleyin.",
