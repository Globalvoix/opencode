export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Thinksoft",
  ...
  "desktop.menu.ariaLabel": "Meniu Thinksoft",
  ...
  "desktop.recovery.loadFailed": "Thinksoft nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Thinksoft s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Thinksoft nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea Thinksoft a eșuat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Thinksoft s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Thinksoft.",
  ...
  "dialog.server.description": "Schimbă serverul Thinksoft la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică Thinksoft în {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Se actualizează Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează Thinksoft în {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Actualizează Thinksoft în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează Thinksoft în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Thinksoft să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Thinksoft.",
  ...
  "toast.update.description": "O nouă versiune Thinksoft ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Thinksoft",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Thinksoft nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Thinksoft în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Thinksoft",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Thinksoft pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Thinksoft urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Thinksoft.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Thinksoft",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Thinksoft.",
  ...
  "server.row.incompatible":
    "Acest server rulează Thinksoft {{version}}, care nu este compatibil cu această aplicație. Actualizați-l la Thinksoft V2 pentru a continua.",
  ...
  "session.error.incompatible.description":
    "{{server}} rulează Thinksoft {{version}}, care nu este compatibil cu această aplicație. Actualizați serverul la Thinksoft V2 pentru a continua.",
  ...
  "settings.about.description": "Thinksoft, agentul de codare open source",
  ...
  "ssh.stage.checking": "Se verifică Thinksoft…",
  "ssh.stage.downloading": "Se descarcă serverul…",
  "ssh.stage.uploading": "Se încarcă serverul…",
  "ssh.stage.starting": "Se conectează la Thinksoft…",
  ...
  "ssh.error.service": "SSH s-a conectat, dar serverul Thinksoft nu a devenit gata.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Acesta nu este un cod de asociere Thinksoft. Scanați codul afișat de opencode pair.",
  ...
  "project.settings.name.description": "Numele afișat pentru acest proiect în Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs disponibil pentru Thinksoft va apărea aici",
  "project.settings.extensions.empty.plugins.title": "Nu există încă pluginuri",
  "project.settings.extensions.empty.plugins.description": "Pluginurile disponibile pentru Thinksoft vor apărea aici",
  "project.settings.extensions.empty.skills.title": "Nu există încă abilități",
  "project.settings.extensions.empty.skills.description": "Abilitățile disponibile pentru Thinksoft vor apărea aici",
  ...
  "settings.workspaces.empty.description": "Arborele de lucru creat în Thinksoft vor apărea aici",
  ...
  "settings.updates.action.download": "Descarcă Thinksoft",
  "settings.updates.migration.title": "Treci de la Beta la Stabil",
  "settings.updates.migration.description":
    "Deocamdată, Thinksoft Beta trece la Thinksoft Stabil. Descarcă versiunea {{version}}, apoi instalează Thinksoft din imaginea de disc pentru a continua să primești actualizări.",
}
