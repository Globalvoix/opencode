export const dict = {
  ...
  "ssh.stage.checking": "Tarkistetaan Thinksoft…",
  "ssh.stage.downloading": "Ladataan palvelinta…",
  "ssh.stage.uploading": "Ladataan palvelinta…",
  "ssh.stage.starting": "Yhdistetään laitteeseen Thinksoft…",
  ...
  "ssh.error.service": "SSH yhdistetty, mutta Thinksoft-palvelin ei tullut valmiiksi.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Tämä ei ole Thinksoft-pariliitoskoodi. Skannaa opencode pair:n näyttämä koodi.",
  ...
  "project.settings.name.description": "Tämän projektin nimi näkyy koko Thinksoft:n kautta",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs saatavilla Thinksoft näkyy tässä",
  "project.settings.extensions.empty.plugins.title": "Ei vielä lisäosia",
  "project.settings.extensions.empty.plugins.description": "Thinksoft:lle saatavilla olevat laajennukset näkyvät täällä",
  "project.settings.extensions.empty.skills.title": "Ei taitoja vielä",
  "project.settings.extensions.empty.skills.description": "Thinksoft:n käytettävissä olevat taidot näkyvät täällä",
  ...
  "settings.workspaces.empty.description": "Thinksoft:llä luodut työtilat näkyvät täällä",
  ...
  "settings.about.description": "Thinksoft, avoimen lähdekoodin koodausagentti",
  ...
  "dialog.model.unpaid.freeModels.title": "Thinksoftn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Thinksoftssa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Thinksoftssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Thinksoftssa.",
  ...
  "dialog.server.description": "Vaihda Thinksoft-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Thinksofta…",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Thinksofta kohteessa {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Päivitetään Thinksofta…",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Thinksofta kohteessa {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Thinksoft jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Thinksoft jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksofta ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Thinksoft voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Thinksoft uudelleen.",
  ...
  "toast.update.description": "Thinksoftn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Thinksoft-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Thinksoft ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Thinksoft-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Thinksoftn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Thinksoft näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Thinksoft järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Thinksoftn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Thinksoft käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Thinksoftn uusinta versiota.",
  ...
  "desktop.menu.documentation": "Thinksoft-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Thinksoft-valikko",
  ...
  "desktop.recovery.loadFailed": "Thinksoftn lataaminen epäonnistui",
  "desktop.recovery.terminated": "Thinksoft-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Thinksoft ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoftn asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksofta ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Thinksoftn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "server.row.incompatible":
    "Tässä palvelimessa on käytössä Thinksoft {{version}}, joka ei ole yhteensopiva tämän sovelluksen kanssa. Jatka päivittämällä palvelin Thinksoft V2:een.",
  ...
  "session.error.incompatible.description":
    "Palvelimessa {{server}} on käytössä Thinksoft {{version}}, joka ei ole yhteensopiva tämän sovelluksen kanssa. Jatka päivittämällä palvelin Thinksoft V2:een.",
  ...
  "settings.updates.action.download": "Lataa Thinksoft",
  "settings.updates.migration.title": "Siirry Betasta vakaaseen versioon",
  "settings.updates.migration.description":
    "Thinksoft Beta siirtyy toistaiseksi Thinksoft Stableen. Lataa versio {{version}} ja asenna sitten Thinksoft levykuvasta, jotta saat jatkossakin päivityksiä.",
}
