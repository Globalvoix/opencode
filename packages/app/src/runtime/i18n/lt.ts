...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Thinksoft įkelti nepavyko",
  "Thinksoft langas netikėtai užsidarė",
  "Thinksoft neatsako",
  ...
  "Thinksoft įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "Thinksoft neįdiegtas distributyve {{distro}}",
  "Thinksoft naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Thinksoft modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Thinksoft.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Thinksoft serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Thinksoft {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Thinksoft {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Thinksoft {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Thinksoft į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Thinksoft galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Thinksoft.",
  ...
  "toast.update.description": "Dabar galima įdiegti naują Thinksoft ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Thinksoft komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Thinksoft dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Thinksoft apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Thinksoft darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Thinksoft serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Thinksoft ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Thinksoft atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Thinksoft seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Thinksoft temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Thinksoft",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Thinksoft versiją.",
  ...
  "server.row.incompatible":
    "Šiame serveryje veikia Thinksoft {{version}}, nesuderinama su šia programa. Norėdami tęsti, atnaujinkite serverį į Thinksoft V2.",
  ...
  "session.error.incompatible.description":
    "Serveryje {{server}} veikia Thinksoft {{version}}, nesuderinama su šia programa. Norėdami tęsti, atnaujinkite serverį į Thinksoft V2.",
  ...
  "settings.about.description": "Thinksoft, atvirojo kodo kodavimo agentas",
  ...
  "ssh.error.service": "SSH prisijungė, bet Thinksoft serveris nepasiruošė.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Tai nėra Thinksoft susiejimo kodas. Nuskaitykite kodą, kurį rodo opencode pair.",
  ...
  "project.settings.name.description": "Šio projekto pavadinimas rodomas visame Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs, pasiekiamas Thinksoft, bus rodomas čia",
  "project.settings.extensions.empty.plugins.title": "Papildinių dar nėra",
  "project.settings.extensions.empty.plugins.description": "Čia bus rodomi Thinksoft prieinami papildiniai",
  "project.settings.extensions.empty.skills.title": "Dar nėra įgūdžių",
  "project.settings.extensions.empty.skills.description": "Čia bus rodomi Thinksoft įgūdžiai",
  ...
  "settings.workspaces.empty.description": "Čia bus rodomi Thinksoft sukurti darbo medžiai",
  ...
  "settings.updates.action.download": "Atsisiųsti „Thinksoft“",
  "settings.updates.migration.title": "Pereiti iš beta į stabilią versiją",
  "settings.updates.migration.description":
    "Kol kas „Thinksoft Beta“ perkeliama į „Thinksoft Stable“. Atsisiųskite {{version}} versiją, tada įdiekite „Thinksoft“ iš disko atvaizdžio, kad ir toliau gautumėte naujinimus.",
}
