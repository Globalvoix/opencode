export const dict = {
  ...
  "desktop.menu.documentation": "Thinksoft hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Thinksoft menyusi",
  ...
  "desktop.recovery.loadFailed": "Thinksoft yuklanmadi",
  "desktop.recovery.terminated": "Thinksoft oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Thinksoft javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoft oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Thinksoft yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Thinksoft tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Thinksoft’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Thinksoft da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Thinksoft da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Thinksoft serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "Thinksoft tekshirilmoqda…",
  "wsl.onboarding.checkingOpencodeIn": "Thinksoft {{distro}} da tekshirilmoqda…",
  "wsl.onboarding.updatingOpencode": "Thinksoft yangilanmoqda…",
  "wsl.onboarding.updatingOpencodeIn": "Thinksoft {{distro}} da yangilanmoqda…",
  "wsl.onboarding.updateOpencodeIn": "Thinksoft-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "Thinksoft-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "Thinksoft tayyor.",
  "wsl.onboarding.installOpencodeIn": "Thinksoft-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "Thinksoft-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Thinksoft WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Thinksoft-ni qayta oching.",
  ...
  "toast.update.description": "Thinksoft ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Thinksoft jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Thinksoft hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Thinksoft bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Thinksoft serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Thinksoft uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Thinksoft qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Thinksoft tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Thinksoft mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Thinksoft ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Thinksoft oxirgi versiyasini ishga tushiryapsiz.",
  ...
  "server.row.incompatible":
    "Bu server ushbu ilovaga mos kelmaydigan Thinksoft {{version}} versiyasini ishlatmoqda. Davom etish uchun uni Thinksoft V2 versiyasiga yangilang.",
  ...
  "session.error.incompatible.description":
    "{{server}} ushbu ilovaga mos kelmaydigan Thinksoft {{version}} versiyasini ishlatmoqda. Davom etish uchun serverni Thinksoft V2 versiyasiga yangilang.",
  ...
  "settings.about.description": "Thinksoft, ochiq manbali kodlash agenti",
  ...
  "ssh.stage.checking": "Thinksoft tekshirilmoqda…",
  "ssh.stage.downloading": "Server yuklanmoqda…",
  "ssh.stage.uploading": "Server yuklanmoqda…",
  "ssh.stage.starting": "Thinksoft ga ulanmoqda…",
  ...
  "ssh.error.service": "SSH ulandi, lekin Thinksoft serveri tayyor emas.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Bu Thinksoft ulash kodi emas. opencode pair koʻrsatgan kodni skanerlang.",
  ...
  "project.settings.name.description": "Ushbu loyiha uchun Thinksoft bo'ylab ko'rsatilgan nom",
  ...
  "project.settings.extensions.empty.mcps.description": "Thinksoft uchun mavjud MCPlar shu yerda paydo bo'ladi",
  "project.settings.extensions.empty.plugins.title": "Hozircha plaginlar yo‘q",
  "project.settings.extensions.empty.plugins.description": "Thinksoft uchun mavjud plaginlar shu yerda paydo bo'ladi",
  "project.settings.extensions.empty.skills.title": "Hali mahorat yo'q",
  "project.settings.extensions.empty.skills.description":
    "Thinksoft uchun mavjud bo'lgan ko'nikmalar bu erda paydo bo'ladi",
  ...
  "settings.workspaces.empty.description": "Thinksoft-da yaratilgan ishchi daraxtlar bu erda paydo bo'ladi",
  ...
  "settings.updates.action.download": "Thinksoft-ni yuklab olish",
  "settings.updates.migration.title": "Beta-dan Stable-ga o‘tish",
  "settings.updates.migration.description":
    "Hozircha Thinksoft Beta Thinksoft Stable-ga o‘tmoqda. Yangilanishlarni olishda davom etish uchun {{version}} versiyasini yuklab oling, so‘ng Thinksoft-ni disk tasviridan o‘rnating.",
