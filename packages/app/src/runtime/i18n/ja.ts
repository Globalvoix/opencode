export const dict = {
  ...
  "desktop.recovery.loadFailed": "Thinksoftを読み込めませんでした",
  "desktop.recovery.terminated": "Thinksoftのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Thinksoftが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoftのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはThinksoftがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Thinksoftのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "Thinksoftが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Thinksoftで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してThinksoftで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Thinksoftで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するThinksoftサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Thinksoftを確認中…",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のThinksoftを確認中…",
  "wsl.onboarding.updatingOpencode": "Thinksoftを更新中…",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のThinksoftを更新中…",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のThinksoftを更新してください。",
  "wsl.onboarding.updateOpencode": "Thinksoftを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のThinksoftの準備ができました。",
  "wsl.onboarding.opencodeReady": "Thinksoftの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にThinksoftをインストールしてください。",
  "wsl.onboarding.installOpencode": "Thinksoftをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoftがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ThinksoftでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Thinksoftをもう一度開いてください。",
  ...
  "toast.update.description": "Thinksoftの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをThinksoftチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: ThinksoftはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Thinksoftには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でThinksoftサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Thinksoftの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのThinksoftの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Thinksoftがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Thinksoftのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Thinksoft の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.action.download": "Thinksoftをダウンロード",
  "settings.updates.migration.title": "ベータ版から安定版へ移行",
  "settings.updates.migration.description":
    "現在、Thinksoft BetaはThinksoft安定版へ移行中です。更新を引き続き受け取るには、バージョン{{version}}をダウンロードし、ディスクイメージからThinksoftをインストールしてください。",
  "settings.updates.action.installing": "インストール中…",
  "settings.updates.toast.latest.title": "最新です",
  "settings.updates.toast.latest.description": "Thinksoft は最新バージョンです。",
  ...
  "server.row.incompatible":
    "このサーバーでは、このアプリと互換性のない Thinksoft {{version}} が実行されています。続行するには Thinksoft V2 にアップグレードしてください。",
  ...
  "session.error.incompatible.description":
    "{{server}} では、このアプリと互換性のない Thinksoft {{version}} が実行されています。続行するには、サーバーを Thinksoft V2 にアップグレードしてください。",
  ...
  "settings.about.description": "オープンソースのコーディングエージェントであるThinksoft",
  ...
  "ssh.stage.checking": "Thinksoftをチェック中…",
  "ssh.stage.downloading": "サーバーをダウンロード中…",
  "ssh.stage.uploading": "サーバーをアップロード中…",
  "ssh.stage.starting": "Thinksoftに接続中…",
  ...
  "ssh.error.service": "SSH は接続されましたが、Thinksoft サーバーが準備できませんでした。",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid":
    "これはThinksoftのペアリングコードではありません。opencode pair に表示されたコードをスキャンしてください。",
  ...
  "project.settings.name.description": "Thinksoft全体でこのプロジェクトに表示される名前",
  ...
  "project.settings.extensions.empty.mcps.description": "Thinksoftで利用可能なMCPはここに表示されます",
  "project.settings.extensions.empty.plugins.title": "まだプラグインはありません",
  "project.settings.extensions.empty.plugins.description": "Thinksoftで利用可能なプラグインはここに表示されます",
  "project.settings.extensions.empty.skills.title": "まだスキルはありません",
  "project.settings.extensions.empty.skills.description": "Thinksoftで利用可能なスキルはここに表示されます",
  ...
  "settings.workspaces.empty.description": "Thinksoftで作成されたワークツリーはここに表示されます",
