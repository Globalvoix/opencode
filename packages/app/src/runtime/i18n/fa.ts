export const dict = {
  ...
  "desktop.menu.documentation": "مستندات Thinksoft",
  ...
  "desktop.menu.ariaLabel": "منوی Thinksoft",
  ...
  "desktop.recovery.loadFailed": "Thinksoft بارگیری نشد",
  "desktop.recovery.terminated": "پنجره Thinksoft به طور غیرمنتظره ای خاتمه یافت",
  "desktop.recovery.unresponsive": "Thinksoft پاسخ نمی دهد",
  ...
  "desktop.wsl.error.installOpencode": "نصب Thinksoft انجام نشد",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft در {{distro}} نصب نشده است",
  "desktop.wsl.error.updateVersion":
    "به‌روزرسانی Thinksoft به پایان رسید، اما {{distro}} همچنان {{installed}} را گزارش می‌کند. مورد انتظار {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "مدل های رایگان ارائه شده توسط Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "کلید API سرویس {{provider}} را وارد کنید تا حساب شما متصل شود و بتوانید از مدل‌های {{provider}} در Thinksoft استفاده کنید.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " برای جمع آوری کد مجوز برای اتصال حساب خود و استفاده از مدل های {{provider}} در Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " و کد زیر را برای اتصال اکانت خود وارد کنید و از مدل های {{provider}} در Thinksoft استفاده کنید.",
  ...
  "dialog.server.description": "این برنامه به کدام سرور Thinksoft متصل است، تغییر دهید.",
  ...
  "wsl.onboarding.checkingOpencode": "در حال بررسی Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "بررسی Thinksoft در {{distro}}…",
  "wsl.onboarding.updatingOpencode": "در حال به روز رسانی Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "به روز رسانی Thinksoft در {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Thinksoft را در {{distro}} به روز کنید.",
  "wsl.onboarding.updateOpencode": "Thinksoft را به روز کنید",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft در {{distro}} آماده است.",
  "wsl.onboarding.opencodeReady": "Thinksoft آماده است.",
  "wsl.onboarding.installOpencodeIn": "Thinksoft را در {{distro}} نصب کنید.",
  "wsl.onboarding.installOpencode": "Thinksoft را نصب کنید",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft نصب نشده است",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (زیر سیستم Windows برای Linux) قبل از اینکه Thinksoft بتواند یک سرور WSL اضافه کند لازم است",
  "wsl.onboarding.wslUnavailable.title": "WSL در دسترس نیست",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft نتوانست WSL را در این دستگاه تأیید کند.",
  "wsl.onboarding.installWsl": "WSL را نصب کنید",
  "wsl.onboarding.windowsRestartRequired":
    "Windows را مجددا راه اندازی کنید تا نصب WSL به پایان برسد، سپس Thinksoft را دوباره باز کنید.",
  ...
  "toast.update.description": "نسخه جدیدی از Thinksoft ({{version}}) اکنون برای نصب در دسترس است.",
  ...
  "error.page.report.prefix": "لطفاً این خطا را به تیم Thinksoft گزارش دهید",
  ...
  "error.chain.mcpFailed":
    'سرور MCP "{{name}}" ناموفق بود. توجه داشته باشید، Thinksoft هنوز از احراز هویت MCP پشتیبانی نمی کند.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft شامل مدل های رایگان است، بنابراین می توانید بلافاصله شروع کنید.",
  ...
  "settings.desktop.wsl.description": "سرور Thinksoft را در داخل WSL روی Windows اجرا کنید.",
  ...
  "settings.general.row.language.description": "زبان نمایش را برای Thinksoft تغییر دهید",
  ...
  "settings.general.row.appearance.description": "نحوه ظاهر Thinksoft را در دستگاه خود سفارشی کنید",
  "settings.general.row.colorScheme.title": "طرح رنگ",
  "settings.general.row.colorScheme.description": "انتخاب کنید که آیا Thinksoft از تم سیستمی، روشن یا تیره پیروی می کند",
  "settings.general.row.theme.title": "موضوع",
  "settings.general.row.theme.description": "نحوه مضمون سازی Thinksoft را سفارشی کنید.",
  ...
  "settings.updates.row.startup.description": "هنگام راه‌اندازی Thinksoft، به‌روزرسانی‌ها را به‌طور خودکار بررسی کنید",
  ...
  "settings.updates.toast.latest.description": "شما آخرین نسخه Thinksoft را اجرا می کنید.",
  ...
  "server.row.incompatible":
    "این سرور Thinksoft \u2068{{version}}\u2069 را اجرا می‌کند که با این برنامه سازگار نیست. برای ادامه، آن را به Thinksoft V2 ارتقا دهید.",
  ...
  "session.error.incompatible.description":
    "\u2068{{server}}\u2069 نسخه Thinksoft \u2068{{version}}\u2069 را اجرا می‌کند که با این برنامه سازگار نیست. برای ادامه، سرور را به Thinksoft V2 ارتقا دهید.",
  ...
  "settings.about.description": "\u2068Thinksoft\u2069، عامل کدنویسی متن‌باز",
  ...
  "ssh.stage.checking": "در حال بررسی Thinksoft…",
  "ssh.stage.downloading": "در حال بارگیری سرور…",
  "ssh.stage.uploading": "در حال بارگذاری سرور…",
  "ssh.stage.starting": "در حال اتصال به Thinksoft…",
  ...
  "ssh.error.service": "SSH متصل شد، اما سرور Thinksoft آماده نشد.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "این کد جفت‌سازی Thinksoft نیست. کدی را پویش کنید که opencode pair نشان می‌دهد.",
  ...
  "project.settings.name.description": "نامی که برای این پروژه در سراسر Thinksoft نشان داده می‌شود",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPهای در دسترس Thinksoft اینجا ظاهر می‌شوند",
  "project.settings.extensions.empty.plugins.title": "هنوز افزونه‌ای وجود ندارد",
  "project.settings.extensions.empty.plugins.description": "افزونه‌های در دسترس Thinksoft اینجا ظاهر می‌شوند",
  "project.settings.extensions.empty.skills.title": "هنوز مهارتی وجود ندارد",
  "project.settings.extensions.empty.skills.description": "مهارت‌های در دسترس Thinksoft اینجا ظاهر می‌شوند",
  ...
  "settings.workspaces.empty.description": "درخت‌های کار ایجادشده در Thinksoft اینجا ظاهر می‌شوند",
  ...
  "settings.updates.action.download": "دانلود Thinksoft",
  "settings.updates.migration.title": "انتقال از بتا به پایدار",
  "settings.updates.migration.description":
    "در حال حاضر Thinksoft Beta به Thinksoft Stable منتقل می‌شود. نسخهٔ \u2068{{version}}\u2069 را دانلود کنید، سپس برای ادامهٔ دریافت به‌روزرسانی‌ها Thinksoft را از تصویر دیسک نصب کنید.",
}
