export const dict = {
  ...
  "desktop.menu.documentation": "Thinksoft Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Thinksoft ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Thinksoft se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Thinksoft se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev Thinksoft ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Thinksoft je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Thinksoft.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Thinksoft se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje Thinksoft …",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje Thinksoft v {{distro}} …",
  "wsl.onboarding.updatingOpencode": "Posodabljanje Thinksoft …",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje Thinksoft v {{distro}} …",
  "wsl.onboarding.updateOpencodeIn": "Posodobite Thinksoft v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite Thinksoft v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Thinksoft doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Thinksoft.",
  ...
  "toast.update.description": "Nova različica Thinksoft ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Thinksoft",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Thinksoft še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Thinksoft znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Thinksoft",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Thinksoft izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Thinksoft sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Thinksoft.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Thinksoft",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Thinksoft.",
  ...
  "server.row.incompatible":
    "Ta strežnik uporablja Thinksoft {{version}}, ki ni združljiv s to aplikacijo. Za nadaljevanje ga nadgradite na Thinksoft V2.",
  ...
  "session.error.incompatible.description":
    "{{server}} uporablja Thinksoft {{version}}, ki ni združljiv s to aplikacijo. Za nadaljevanje strežnik nadgradite na Thinksoft V2.",
  ...
  "settings.about.description": "Thinksoft, odprtokodni agent za kodiranje",
  ...
  "ssh.stage.checking": "Preverjam Thinksoft…",
  "ssh.stage.downloading": "Pridobivanje strežnika…",
  "ssh.stage.uploading": "Nalagam strežnik…",
  "ssh.stage.starting": "Povezovanje z Thinksoft…",
  ...
  "ssh.error.service": "SSH povezan, vendar Thinksoft strežnik ni postal pripravljen.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "To ni Thinksoft paritna koda. Skenirajte kodo, ki jo prikaže opencode pair.",
  ...
  "project.settings.name.description": "Ime, ki se prikaže za ta projekt v Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCP-ji, na voljo za Thinksoft, se bodo prikazali tukaj",
  "project.settings.extensions.empty.plugins.title": "Še ni vtičnikov",
  "project.settings.extensions.empty.plugins.description": "Vtičniki, na voljo za Thinksoft, se bodo prikazali tukaj",
  "project.settings.extensions.empty.skills.title": "Še ni veščin",
  "project.settings.extensions.empty.skills.description": "Veščine, na voljo za Thinksoft, se bodo prikazale tukaj",
  ...
  "settings.workspaces.empty.description": "Delovna drevesa, ustvarjena v Thinksoft, se bodo prikazala tukaj",
  ...
  "settings.updates.action.download": "Prenesi Thinksoft",
  "settings.updates.migration.title": "Prehod z Beta na Stable",
  "settings.updates.migration.description":
    "Thinksoft Beta se za zdaj seli na Thinksoft Stable. Prenesite različico {{version}}, nato pa namestite Thinksoft iz slike diska, da boste še naprej prejemali posodobitve.",
