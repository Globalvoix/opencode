export const dict = {
  ...
  "desktop.menu.documentation": "Thinksoft Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "Thinksoft μενού",
  ...
  "desktop.recovery.loadFailed": "Thinksoft απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "Thinksoft το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "Thinksoft δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoft η εγκατάσταση απέτυχε",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Thinksoft η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο Thinksoft.",
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Thinksoft.",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή Thinksoft συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.step.opencode": "Thinksoft",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος Thinksoft σε {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση Thinksoft σε {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση Thinksoft σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του Thinksoft στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο Thinksoft να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το Thinksoft.",
  ...
  "toast.update.description": "Μια νέα έκδοση του Thinksoft ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα Thinksoft",
  ...
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το Thinksoft δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "Thinksoft Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή Thinksoft μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το Thinksoft",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του Thinksoft στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το Thinksoft ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το Thinksoft.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του Thinksoft",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του Thinksoft.",
  ...
  "server.row.incompatible":
    "Αυτός ο διακομιστής εκτελεί το Thinksoft {{version}}, το οποίο δεν είναι συμβατό με αυτήν την εφαρμογή. Αναβαθμίστε τον σε Thinksoft V2 για να συνεχίσετε.",
  ...
  "session.error.incompatible.description":
    "Ο διακομιστής {{server}} εκτελεί το Thinksoft {{version}}, το οποίο δεν είναι συμβατό με αυτήν την εφαρμογή. Αναβαθμίστε τον διακομιστή σε Thinksoft V2 για να συνεχίσετε.",
  ...
  "settings.about.description": "Thinksoft, ο παράγοντας κωδικοποίησης ανοιχτού κώδικα",
  ...
  "ssh.error.service": "Ο SSH συνδέθηκε, αλλά ο διακομιστής Thinksoft δεν ήταν έτοιμος.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid":
    "Αυτός δεν είναι κωδικός σύζευξης Thinksoft. Σαρώστε τον κωδικό που εμφανίζεται από το opencode pair.",
  ...
  "project.settings.name.description": "Το όνομα που εμφανίζεται για αυτό το έργο σε όλο το Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "Το MCPs διαθέσιμο στο Thinksoft θα εμφανιστεί εδώ",
  ...
  "project.settings.extensions.empty.plugins.description":
    "Τα πρόσθετα που είναι διαθέσιμα στο Thinksoft θα εμφανιστούν εδώ",
  ...
  "project.settings.extensions.empty.skills.description":
    "Οι δεξιότητες που είναι διαθέσιμες στο Thinksoft θα εμφανιστούν εδώ",
  ...
  "settings.workspaces.empty.description": "Τα δέντρα εργασίας που δημιουργήθηκαν στο Thinksoft θα εμφανιστούν εδώ",
  ...
  "settings.updates.action.download": "Λήψη του Thinksoft",
  "settings.updates.migration.title": "Μετάβαση από Beta σε Σταθερή",
  "settings.updates.migration.description":
    "Προς το παρόν, το Thinksoft Beta μεταφέρεται στο Thinksoft Stable. Κάντε λήψη της έκδοσης {{version}} και, στη συνέχεια, εγκαταστήστε το Thinksoft από το είδωλο δίσκου για να συνεχίσετε να λαμβάνετε ενημερώσεις.",
}
