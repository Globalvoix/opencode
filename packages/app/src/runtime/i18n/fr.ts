export const dict = {
  ...
  "ssh.error.service": "SSH s'est connecté, mais le serveur Thinksoft n'est pas prêt.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid":
    "Il ne s'agit pas d'un code d'appairage Thinksoft. Scannez le code affiché par opencode pair.",
  ...
  "project.settings.name.description": "Le nom affiché pour ce projet dans Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs disponible pour Thinksoft apparaîtra ici",
  "project.settings.extensions.empty.plugins.title": "Pas encore de plugin",
  "project.settings.extensions.empty.plugins.description": "Les plugins disponibles pour Thinksoft apparaîtront ici",
  "project.settings.extensions.empty.skills.title": "Aucune compétence pour l'instant",
  "project.settings.extensions.empty.skills.description": "Les compétences disponibles pour Thinksoft apparaîtront ici",
  ...
  "settings.workspaces.empty.description": "Les espaces de travail créés dans Thinksoft apparaîtront ici",
  ...
  "settings.about.description": "Thinksoft, l’agent de programmation open source",
  ...
  "desktop.menu.documentation": "Documentation d'Thinksoft",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Thinksoft",
  "desktop.recovery.terminated": "La fenêtre Thinksoft s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Thinksoft ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Thinksoft",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Thinksoft est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Thinksoft.",
  ...
  "dialog.server.description": "Changez le serveur Thinksoft auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Thinksoft dans {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Thinksoft dans {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Thinksoft dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Thinksoft dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Thinksoft puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Thinksoft.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Thinksoft ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Thinksoft",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Thinksoft ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Thinksoft inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Thinksoft dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Thinksoft",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Thinksoft sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Thinksoft suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Thinksoft.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Thinksoft",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Thinksoft.",
  ...
  "server.row.incompatible":
    "Ce serveur exécute Thinksoft {{version}}, qui n'est pas compatible avec cette application. Mettez-le à niveau vers Thinksoft V2 pour continuer.",
  ...
  "session.error.incompatible.description":
    "{{server}} exécute Thinksoft {{version}}, qui n'est pas compatible avec cette application. Mettez le serveur à niveau vers Thinksoft V2 pour continuer.",
  ...
  "settings.updates.action.download": "Télécharger Thinksoft",
  "settings.updates.migration.title": "Passer de la version bêta à la version stable",
  "settings.updates.migration.description":
    "Pour le moment, Thinksoft Beta passe à Thinksoft Stable. Téléchargez la version {{version}}, puis installez Thinksoft depuis l’image disque pour continuer à recevoir les mises à jour.",
}
