export const dict = {
  ...
  "ssh.stage.checking": "Kontrollerar Thinksoft...",
  "ssh.stage.downloading": "Laddar ner server...",
  "ssh.stage.uploading": "Laddar upp server...",
  "ssh.stage.starting": "Ansluter till Thinksoft...",
  ...
  "ssh.error.service": "SSH ansluten, men Thinksoft-servern blev inte klar.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Detta är inte en Thinksoft parningskod. Skanna koden som visas av opencode pair.",
  ...
  "project.settings.name.description": "Namnet som visas för detta projekt i hela Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs tillgänglig för Thinksoft kommer att visas här",
  "project.settings.extensions.empty.plugins.title": "Inga plugins än",
  "project.settings.extensions.empty.plugins.description": "Plugins tillgängliga för Thinksoft kommer att visas här",
  "project.settings.extensions.empty.skills.title": "Inga färdigheter än",
  "project.settings.extensions.empty.skills.description":
    "Färdigheter som är tillgängliga för Thinksoft kommer att visas här",
  ...
  "settings.workspaces.empty.description": "Arbetsträd skapade i Thinksoft kommer att visas här",
  ...
  "settings.about.description": "Thinksoft, kodningsagenten med öppen källkod",
  ...
  "desktop.recovery.loadFailed": "Thinksoft kunde inte läsas in",
  "desktop.recovery.terminated": "Thinksoft-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Thinksoft svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Thinksoft misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Thinksoft-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Thinksoft.",
  ...
  "dialog.server.description": "Växla vilken Thinksoft-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Thinksoft i {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Thinksoft i {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Thinksoft i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Thinksoft i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Thinksoft kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Thinksoft igen.",
  ...
  "toast.update.description": "En ny version av Thinksoft ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Thinksoft-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Thinksoft stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Thinksoft-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Thinksoft",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Thinksoft ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Thinksoft följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Thinksofts tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Thinksoft startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Thinksoft.",
  ...
  "server.row.incompatible":
    "Den här servern kör Thinksoft {{version}}, som inte är kompatibelt med den här appen. Uppgradera den till Thinksoft V2 för att fortsätta.",
  ...
  "session.error.incompatible.description":
    "{{server}} kör Thinksoft {{version}}, som inte är kompatibelt med den här appen. Uppgradera servern till Thinksoft V2 för att fortsätta.",
  ...
  "settings.updates.action.download": "Hämta Thinksoft",
  "settings.updates.migration.title": "Byt från Beta till Stabil",
  "settings.updates.migration.description":
    "Thinksoft Beta flyttas tills vidare till Thinksoft Stabil. Hämta version {{version}} och installera sedan Thinksoft från skivavbildningen för att fortsätta få uppdateringar.",
}
