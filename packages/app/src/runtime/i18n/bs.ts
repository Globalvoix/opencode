export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Thinksoft",
  ...
  "desktop.menu.ariaLabel": "Thinksoft meni",
  ...
  "desktop.recovery.loadFailed": "Thinksoft se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Thinksoft-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Thinksoft ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Thinksoft-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Thinksoft-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Thinksoft-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Thinksoft-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Thinksoft-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Thinksoft server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Thinksoft u distribuciji {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Thinksoft u distribuciji {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Thinksoft u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Thinksoft u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Thinksoft mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Thinksoft.",
  ...
  "toast.update.description": "Nova verzija Thinksoft-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Thinksoft timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Thinksoft još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Thinksoft server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Thinksoft-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Thinksoft izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Thinksoft prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Thinksoft-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Thinksoft pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Thinksoft-a.",
  ...
  "server.row.incompatible":
    "Ovaj server koristi Thinksoft {{version}}, koji nije kompatibilan s ovom aplikacijom. Nadogradite ga na Thinksoft V2 da biste nastavili.",
  ...
  "session.error.incompatible.description":
    "{{server}} koristi Thinksoft {{version}}, koji nije kompatibilan s ovom aplikacijom. Nadogradite server na Thinksoft V2 da biste nastavili.",
  ...
  "settings.about.description": "Thinksoft, agent za kodiranje otvorenog koda",
  ...
  "ssh.stage.checking": "Provjera Thinksoft-a…",
  "ssh.stage.downloading": "Preuzimanje servera…",
  "ssh.stage.uploading": "Slanje servera…",
  "ssh.stage.starting": "Povezivanje s Thinksoft-om…",
  ...
  "ssh.error.service": "SSH je povezan, ali Thinksoft server nije postao spreman.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Ovo nije Thinksoft kod za uparivanje. Skenirajte kod koji prikazuje opencode pair.",
  ...
  "project.settings.name.description": "Naziv koji se prikazuje za ovaj projekat u cijelom Thinksoft-u",
  ...
  "project.settings.extensions.empty.mcps.description": "MCP-ovi dostupni Thinksoft-u pojavit će se ovdje",
  "project.settings.extensions.empty.plugins.title": "Još nema dodataka",
  "project.settings.extensions.empty.plugins.description": "Dodaci dostupni Thinksoft-u pojavit će se ovdje",
  "project.settings.extensions.empty.skills.title": "Još nema vještina",
  "project.settings.extensions.empty.skills.description": "Vještine dostupne Thinksoft-u pojavit će se ovdje",
  ...
  "settings.workspaces.empty.description": "Worktreeovi kreirani u Thinksoft-u pojavit će se ovdje",
  ...
  "settings.updates.action.download": "Preuzmi Thinksoft",
  "settings.updates.migration.title": "Prelazak sa Beta na Stable",
  "settings.updates.migration.description":
    "Thinksoft Beta za sada prelazi na Thinksoft Stable. Preuzmite verziju {{version}}, a zatim instalirajte Thinksoft iz slike diska da biste nastavili primati ažuriranja.",
