export const dict = {
  ...
  "ssh.stage.checking": "Comprobando Thinksoft…",
  "ssh.stage.downloading": "Descargando servidor…",
  "ssh.stage.uploading": "Subiendo servidor…",
  "ssh.stage.starting": "Conectándose a Thinksoft…",
  ...
  "ssh.error.service": "SSH se conectó, pero el servidor Thinksoft no estuvo listo.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid":
    "Este no es un código de emparejamiento Thinksoft. Escanea el código mostrado por opencode pair.",
  ...
  "project.settings.name.description": "El nombre que se muestra para este proyecto en todo Thinksoft.",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs disponible para Thinksoft aparecerá aquí",
  "project.settings.extensions.empty.plugins.title": "Aún no hay complementos",
  "project.settings.extensions.empty.plugins.description": "Los complementos disponibles para Thinksoft aparecerán aquí",
  "project.settings.extensions.empty.skills.title": "Aún no hay habilidades",
  "project.settings.extensions.empty.skills.description": "Las habilidades disponibles para Thinksoft aparecerán aquí",
  ...
  "settings.workspaces.empty.description": "Los espacios de trabajo creados en Thinksoft aparecerán aquí",
  ...
  "settings.about.description": "Thinksoft, el agente de programación de código abierto",
  ...
  "desktop.menu.documentation": "Documentación de Thinksoft",
  ...
  "desktop.menu.ariaLabel": "Menú de Thinksoft",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Thinksoft",
  "desktop.recovery.terminated": "La ventana de Thinksoft se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Thinksoft no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Thinksoft",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Thinksoft finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Thinksoft.",
  ...
  "dialog.server.description": "Cambiar el servidor de Thinksoft al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Thinksoft en {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Actualizando Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Thinksoft en {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Thinksoft en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Thinksoft en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Thinksoft pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Thinksoft.",
  ...
  "toast.update.description": "Una nueva versión de Thinksoft ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Thinksoft",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Thinksoft aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Thinksoft dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Thinksoft",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Thinksoft en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Thinksoft sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Thinksoft.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Thinksoft",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Thinksoft.",
  ...
  "server.row.incompatible":
    "Este servidor ejecuta Thinksoft {{version}}, que no es compatible con esta aplicación. Actualízalo a Thinksoft V2 para continuar.",
  ...
  "session.error.incompatible.description":
    "{{server}} ejecuta Thinksoft {{version}}, que no es compatible con esta aplicación. Actualiza el servidor a Thinksoft V2 para continuar.",
  ...
  "settings.updates.action.download": "Descargar Thinksoft",
  "settings.updates.migration.title": "Pasar de Beta a Estable",
  "settings.updates.migration.description":
    "Por ahora, Thinksoft Beta se está trasladando a Thinksoft Estable. Descarga la versión {{version}} e instala Thinksoft desde la imagen de disco para seguir recibiendo actualizaciones.",
}
