export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni Thinksoft",
  ...
  "desktop.menu.ariaLabel": "Menuja Thinksoft",
  ...
  "desktop.recovery.loadFailed": "Thinksoft nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja Thinksoft u mbyll papritur",
  "desktop.recovery.unresponsive": "Thinksoft nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i Thinksoft dështoi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i Thinksoft përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Thinksoft.",
  ...
  "dialog.server.description": "Ndrysho me cilin server Thinksoft lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon Thinksoft në {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Thinksoft po përditësohet…",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson Thinksoft në {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Përditëso Thinksoft në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft është gati në {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni Thinksoft në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se Thinksoft të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap Thinksoft.",
  ...
  "toast.update.description": "Një version i ri i Thinksoft ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i Thinksoft",
  ...
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, Thinksoft nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin Thinksoft brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për Thinksoft",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket Thinksoft në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse Thinksoft ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e Thinksoft.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset Thinksoft",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të Thinksoft.",
  ...
  "server.row.incompatible":
    "Ky server po ekzekuton Thinksoft {{version}}, i cili nuk përputhet me këtë aplikacion. Për ta vazhduar, përmirësojeni në Thinksoft V2.",
  ...
  "session.error.incompatible.description":
    "{{server}} po ekzekuton Thinksoft {{version}}, i cili nuk përputhet me këtë aplikacion. Për ta vazhduar, përmirësoni serverin në Thinksoft V2.",
  ...
  "settings.about.description": "Thinksoft, agjenti kodues me burim të hapur",
  ...
  "ssh.stage.checking": "Po kontrollon Thinksoft…",
  "ssh.stage.downloading": "Serveri po shkarkohet…",
  "ssh.stage.uploading": "Serveri i ngarkimit…",
  "ssh.stage.starting": "Po lidhet me Thinksoft…",
  ...
  "ssh.error.service": "SSH u lidh, por serveri Thinksoft nuk u bë gati.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Ky nuk është një kod çiftimi Thinksoft. Skanoni kodin e treguar nga opencode pair.",
  ...
  "project.settings.name.description": "Emri i shfaqur për këtë projekt në të gjithë Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs i disponueshëm për Thinksoft do të shfaqet këtu",
  "project.settings.extensions.empty.plugins.title": "Nuk ka ende shtojca",
  "project.settings.extensions.empty.plugins.description": "Shtojcat e disponueshme për Thinksoft do të shfaqen këtu",
  "project.settings.extensions.empty.skills.title": "Nuk ka ende aftësi",
  "project.settings.extensions.empty.skills.description": "Aftësitë e disponueshme për Thinksoft do të shfaqen këtu",
  ...
  "settings.workspaces.empty.description": "Pemët e punës të krijuara në Thinksoft do të shfaqen këtu",
  ...
  "settings.updates.action.download": "Shkarko Thinksoft",
  "settings.updates.migration.title": "Kalo nga Beta në versionin e qëndrueshëm",
  "settings.updates.migration.description":
    "Për momentin, Thinksoft Beta po kalon te Thinksoft Stable. Shkarko versionin {{version}}, pastaj instalo Thinksoft nga imazhi i diskut për të vazhduar marrjen e përditësimeve.",
}
