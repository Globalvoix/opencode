...
export const dict = {
  ...
  "ssh.error.service": "SSH koblet til, men Thinksoft-serveren ble ikke klar.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Dette er ikke en Thinksoft-paringskode. Skann koden vist av opencode pair.",
  ...
  "project.settings.name.description": "Navnet som vises for dette prosjektet gjennom hele Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs tilgjengelig for Thinksoft vil vises her",
  "project.settings.extensions.empty.plugins.title": "Ingen plugins ennå",
  "project.settings.extensions.empty.plugins.description": "Plugins tilgjengelig for Thinksoft vil vises her",
  "project.settings.extensions.empty.skills.title": "Ingen ferdigheter ennå",
  "project.settings.extensions.empty.skills.description": "Ferdigheter tilgjengelig for Thinksoft vil vises her",
  ...
  "settings.workspaces.empty.description": "Arbeidstre opprettet i Thinksoft vil vises her",
  ...
  "settings.about.description": "Thinksoft, kodeagenten med åpen kildekode",
  ...
  "desktop.menu.documentation": "Thinksoft-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Thinksoft-meny",
  ...
  "desktop.recovery.loadFailed": "Thinksoft kunne ikke lastes inn",
  "desktop.recovery.terminated": "Thinksoft-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Thinksoft svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Thinksoft mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Thinksoft er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Thinksoft.",
  ...
  "dialog.server.description": "Bytt hvilken Thinksoft-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Thinksoft ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Thinksoft-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Thinksoft ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Thinksoft-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Thinksoft",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Thinksoft ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Thinksoft skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Thinksoft.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Thinksoft starter",
  ...
  "settings.updates.toast.latest.title": "Thinksoft er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Thinksoft.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Thinksoft i {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Thinksoft i {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Thinksoft i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Thinksoft i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Thinksoft kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Thinksoft på nytt.",
  ...
  "server.row.incompatible":
    "Denne serveren kjører Thinksoft {{version}}, som ikke er kompatibel med denne appen. Oppgrader den til Thinksoft V2 for å fortsette.",
  ...
  "session.error.incompatible.description":
    "{{server}} kjører Thinksoft {{version}}, som ikke er kompatibel med denne appen. Oppgrader serveren til Thinksoft V2 for å fortsette.",
  ...
  "settings.updates.action.download": "Last ned Thinksoft",
  "settings.updates.migration.title": "Bytt fra Beta til Stabil",
  "settings.updates.migration.description":
    "Thinksoft Beta flyttes foreløpig til Thinksoft Stabil. Last ned versjon {{version}}, og installer deretter Thinksoft fra diskavbildningen for å fortsette å motta oppdateringer.",
