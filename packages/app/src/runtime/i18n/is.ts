...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Thinksoft",
  "Thinksoft-glugganum var óvænt lokað",
  "Thinksoft svarar ekki",
  ...
  "Thinksoft er ekki uppsett í {{distro}}",
  "Uppfærslu Thinksoft lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Thinksoft.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Thinksoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Thinksoft.",
  ...
  "dialog.server.description": "Skiptu um hvaða Thinksoft miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar Thinksoft…",
  "wsl.onboarding.checkingOpencodeIn": "Athugar Thinksoft í {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Uppfærir Thinksoft…",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir Thinksoft í {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu Thinksoft í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu Thinksoft",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp Thinksoft í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Thinksoft getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Thinksoft aftur.",
  ...
  "toast.update.description": "Ný útgáfa af Thinksoft ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Thinksoft teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Thinksoft styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Thinksoft inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Thinksoft skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Thinksoft netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Thinksoft",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Thinksoft lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Thinksoft fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Thinksoft er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Thinksoft ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Thinksoft.",
  ...
  "server.row.incompatible":
    "Þessi netþjónn keyrir Thinksoft {{version}}, sem er ekki samhæft þessu forriti. Uppfærðu hann í Thinksoft V2 til að halda áfram.",
  ...
  "session.error.incompatible.description":
    "{{server}} keyrir Thinksoft {{version}}, sem er ekki samhæft þessu forriti. Uppfærðu netþjóninn í Thinksoft V2 til að halda áfram.",
  ...
  "settings.about.description": "Thinksoft, opinn kóðunaraðili",
  ...
  "ssh.stage.checking": "Athugar Thinksoft…",
  "ssh.stage.downloading": "Sækir miðlara…",
  "ssh.stage.uploading": "Hleður upp þjóni...",
  "ssh.stage.starting": "Tengist Thinksoft…",
  ...
  "ssh.error.service": "SSH tengdur, en Thinksoft þjónninn varð ekki tilbúinn.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Þetta er ekki Thinksoft pörunarkóði. Skannaðu kóðann sem opencode pair sýnir.",
  ...
  "project.settings.name.description": "Nafnið sem sýnt er fyrir þetta verkefni í gegnum Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs í boði fyrir Thinksoft mun birtast hér",
  "project.settings.extensions.empty.plugins.title": "Engar viðbætur ennþá",
  "project.settings.extensions.empty.plugins.description": "Viðbætur sem eru í boði fyrir Thinksoft munu birtast hér",
  "project.settings.extensions.empty.skills.title": "Engar færni enn",
  "project.settings.extensions.empty.skills.description": "Hæfni í boði fyrir Thinksoft mun birtast hér",
  ...
  "settings.workspaces.empty.description": "Vinnutré sem búin eru til í Thinksoft munu birtast hér",
  ...
  "settings.updates.action.download": "Sækja Thinksoft",
  "settings.updates.migration.title": "Fara úr Beta í Stöðuga útgáfu",
  "settings.updates.migration.description":
    "Thinksoft Beta er um sinn að færast yfir í Thinksoft Stable. Sæktu útgáfu {{version}} og settu síðan Thinksoft upp úr diskmyndinni til að halda áfram að fá uppfærslur.",
}
