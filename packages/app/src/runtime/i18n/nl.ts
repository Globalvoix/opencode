export const dict = {
  ...
  "ssh.stage.checking": "Thinksoft controleren…",
  "ssh.stage.downloading": "Server downloaden…",
  "ssh.stage.uploading": "Server uploaden…",
  "ssh.stage.starting": "Verbinding maken met Thinksoft…",
  ...
  "ssh.error.service": "SSH verbonden, maar de Thinksoft-server is niet gereed geworden.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Dit is geen Thinksoft-koppelingscode. Scan de code weergegeven door opencode pair.",
  ...
  "project.settings.name.description": "De naam die overal in Thinksoft voor dit project wordt weergegeven",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs beschikbaar voor Thinksoft wordt hier weergegeven",
  "project.settings.extensions.empty.plugins.title": "Nog geen plug-ins",
  "project.settings.extensions.empty.plugins.description":
    "Plug-ins die beschikbaar zijn voor Thinksoft verschijnen hier",
  "project.settings.extensions.empty.skills.title": "Nog geen vaardigheden",
  "project.settings.extensions.empty.skills.description":
    "Vaardigheden die beschikbaar zijn voor Thinksoft worden hier weergegeven",
  ...
  "settings.workspaces.empty.description": "Werkbomen die in Thinksoft zijn gemaakt, verschijnen hier",
  ...
  "settings.about.description": "Thinksoft, de open-source programmeeragent",
  ...
  "desktop.menu.documentation": "Thinksoft-documentatie",
  ...
  "desktop.recovery.loadFailed": "Thinksoft kan niet worden geladen",
  "desktop.recovery.terminated": "Het Thinksoft-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Thinksoft reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Thinksoft is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Thinksoft-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Thinksoft",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Thinksoft te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Thinksoft te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Thinksoft te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke Thinksoft-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Thinksoft controleren…",
  "wsl.onboarding.checkingOpencodeIn": "Thinksoft controleren in {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Thinksoft bijwerken…",
  "wsl.onboarding.updatingOpencodeIn": "Thinksoft bijwerken in {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Werk Thinksoft bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Thinksoft bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Thinksoft is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Thinksoft in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Thinksoft",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Thinksoft een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Thinksoft opnieuw.",
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Thinksoft ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Thinksoft-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Thinksoft ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Thinksoft-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Thinksoft",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Thinksoft eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Thinksoft het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Thinksoft aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Thinksoft wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Thinksoft is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Thinksoft.",
  ...
  "server.row.incompatible":
    "Op deze server wordt Thinksoft {{version}} uitgevoerd, dat niet compatibel is met deze app. Werk de server bij naar Thinksoft V2 om door te gaan.",
  ...
  "session.error.incompatible.description":
    "Op {{server}} wordt Thinksoft {{version}} uitgevoerd, dat niet compatibel is met deze app. Werk de server bij naar Thinksoft V2 om door te gaan.",
  ...
  "settings.updates.action.download": "Thinksoft downloaden",
  "settings.updates.migration.title": "Van Beta naar Stabiel overstappen",
  "settings.updates.migration.description":
    "Thinksoft Beta gaat voorlopig over naar Thinksoft Stabiel. Download versie {{version}} en installeer Thinksoft daarna vanaf de schijfkopie om updates te blijven ontvangen.",
}
