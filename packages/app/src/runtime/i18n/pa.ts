export const dict = {
  ...
  "desktop.menu.documentation": "Thinksoft دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "Thinksoft لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Thinksoft دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Thinksoft جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoft دی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "\u2068{{distro}}\u2069 وچ Thinksoft انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "Thinksoft دی اپ ڈیٹ پوری ہو گئی پر \u2068{{distro}}\u2069 ہلے وی \u2068{{installed}}\u2069 دس رہیا اے؛ \u2068{{expected}}\u2069 چاہیدا سی",
  ...
  "dialog.model.unpaid.freeModels.title": "Thinksoft دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی \u2068{{provider}}\u2069 API کلید درج کرو تے Thinksoft وچ \u2068{{provider}}\u2069 ماڈل ورتو۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Thinksoft وچ \u2068{{provider}}\u2069 ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Thinksoft وچ \u2068{{provider}}\u2069 ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.server.description": "ایہہ ایپ کس Thinksoft سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpencode": "Thinksoft چیک کر رئے آں…",
  "wsl.onboarding.checkingOpencodeIn": "\u2068{{distro}}\u2069 چ Thinksoft دی جانچ پڑتال…",
  "wsl.onboarding.updatingOpencode": "Thinksoft نو اپ ڈیٹ کر رئے آں…",
  "wsl.onboarding.updatingOpencodeIn": "\u2068{{distro}}\u2069 وچ Thinksoft نو اپ ڈیٹ کر رئے آں…",
  "wsl.onboarding.updateOpencodeIn": "\u2068{{distro}}\u2069 وچ Thinksoft نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "Thinksoft اپ ڈیٹ کرو",
  "wsl.onboarding.opencodeReadyIn": "Thinksoft \u2068{{distro}}\u2069 چ تیار اے۔",
  "wsl.onboarding.opencodeReady": "Thinksoft تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "\u2068{{distro}}\u2069 وچ Thinksoft انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "Thinksoft انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Thinksoft انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Thinksoft دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Thinksoft ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Thinksoft دوبارہ کھولو۔",
  ...
  "toast.update.description": "Thinksoft (\u2068{{version}}\u2069) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Thinksoft ٹیم نوں دیو",
  ...
  "error.chain.mcpFailed":
    'MCP سرور "\u2068{{name}}\u2069" ناکام ہو گیا۔ نوٹ، Thinksoft ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "Thinksoft چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Thinksoft سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "Thinksoft لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Thinksoft کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Thinksoft سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Thinksoft نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Thinksoft لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی Thinksoft دا تازہ ترین ورژن چلا رئے او۔",
  ...
  "server.row.incompatible":
    "ایس سرور تے Thinksoft \u2068{{version}}\u2069 چل رہیا اے، جہڑا ایس ایپ نال میل نئیں کھاندا۔ جاری رکھن لئی اینوں Thinksoft V2 تے اپ گریڈ کرو۔",
  ...
  "session.error.incompatible.description":
    "\u2068{{server}}\u2069 تے Thinksoft \u2068{{version}}\u2069 چل رہیا اے، جہڑا ایس ایپ نال میل نئیں کھاندا۔ جاری رکھن لئی سرور نوں Thinksoft V2 تے اپ گریڈ کرو۔",
  ...
  "ssh.error.service": "SSH منسلک، لیکن Thinksoft سرور تیار نئیں ہوا۔",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid":
    "یہ Thinksoft جوڑا بنانے والا کوڈ نئیں اے۔ اوپن کوڈ جوڑی دے ذریعہ دکھائے گئے کوڈ کو اسکین کرو۔",
  ...
  "project.settings.name.description": "پورے Thinksoft میں اس پروجیکٹ لئی دکھایا گیا نام",
  ...
  "project.settings.extensions.empty.plugins.description": "Thinksoft لئی دستیاب پلگ انز یہاں ظاہر ہوں گے۔",
  ...
  "settings.updates.action.download": "Thinksoft ڈاؤن لوڈ کرو",
  "settings.updates.migration.title": "بیٹا توں مستحکم ورژن ول جاؤ",
  "settings.updates.migration.description":
    "فی الحال Thinksoft Beta نوں Thinksoft Stable وچ منتقل کیتا جا ریا اے۔ ورژن \u2068{{version}}\u2069 ڈاؤن لوڈ کرو، فیر اپ ڈیٹ ملدے رہن لئی ڈسک امیج توں Thinksoft انسٹال کرو۔",
}
