...
const desktop = [
  ...
  "Kilépés",
  "Az Thinksoft betöltése sikertelen",
  "Az Thinksoft ablaka váratlanul leállt",
  "Az Thinksoft nem válaszol",
  ...
  "Az Thinksoft telepítése sikertelen",
  ...
  "Az Thinksoft nincs telepítve ebben: {{distro}}",
  "Az Thinksoft frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "A Thinksoft ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a Thinksoft-ben.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a Thinksoft-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a Thinksoft-ben.",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik Thinksoft szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingOpencode": "Thinksoft ellenőrzése…",
  "wsl.onboarding.checkingOpencodeIn": "Thinksoft ellenőrzése a {{distro}}-ben…",
  "wsl.onboarding.updatingOpencode": "Thinksoft frissítése…",
  "wsl.onboarding.updatingOpencodeIn": "Thinksoft frissítése a {{distro}}-ben…",
  "wsl.onboarding.updateOpencodeIn": "Frissítse a Thinksoft-t a {{distro}}-ben.",
  "wsl.onboarding.updateOpencode": "Frissítse a Thinksoft-t",
  "wsl.onboarding.opencodeReadyIn": "A Thinksoft készen áll a {{distro}}-ben.",
  "wsl.onboarding.opencodeReady": "A Thinksoft készen áll.",
  "wsl.onboarding.installOpencodeIn": "Telepítse a Thinksoft-t a {{distro}}-be.",
  "wsl.onboarding.installOpencode": "Telepítse a Thinksoft-t",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "A Thinksoft nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a Thinksoft hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A Thinksoft nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a Thinksoft programot.",
  ...
  "toast.update.description": "A Thinksoft ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a Thinksoft csapatának",
  ...
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a Thinksoft még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A Thinksoft ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "Thinksoft asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a Thinksoft szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a Thinksoft kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a Thinksoft az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a Thinksoft a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a Thinksoft témáját.",
  ...
  "settings.updates.row.startup.description": "A Thinksoft indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a Thinksoft legújabb verzióját futtatja.",
  ...
  "server.row.incompatible":
    "Ez a kiszolgáló az Thinksoft {{version}} verzióját futtatja, amely nem kompatibilis ezzel az alkalmazással. A folytatáshoz frissítse Thinksoft V2-re.",
  ...
  "session.error.incompatible.description":
    "A(z) {{server}} az Thinksoft {{version}} verzióját futtatja, amely nem kompatibilis ezzel az alkalmazással. A folytatáshoz frissítse a kiszolgálót Thinksoft V2-re.",
  ...
  "settings.about.description": "Thinksoft, a nyílt forráskódú kódoló ügynök",
  ...
  "ssh.stage.checking": "Thinksoft ellenőrzése…",
  "ssh.stage.downloading": "Szerver letöltése…",
  "ssh.stage.uploading": "Szerver feltöltése…",
  "ssh.stage.starting": "Csatlakozás a Thinksoft-hez…",
  ...
  "ssh.error.service": "A SSH csatlakozott, de a Thinksoft szerver nem vált készenlétben.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Ez nem egy Thinksoft párosítási kód. Olvassa be a opencode pair által mutatott kódot.",
  ...
  "project.settings.name.description": "A projekt neve a Thinksoft",
  ...
  "project.settings.extensions.empty.mcps.description": "A Thinksoft számára elérhető MCPs itt jelenik meg",
  ...
  "project.settings.extensions.empty.plugins.description":
    "A Thinksoft számára elérhető beépülő modulok itt jelennek meg",
  "project.settings.extensions.empty.skills.title": "Még nincsenek készségek",
  "project.settings.extensions.empty.skills.description": "A Thinksoft számára elérhető készségek itt jelennek meg",
  ...
  "settings.workspaces.empty.description": "A Thinksoft-ben létrehozott munkafák itt jelennek meg",
  ...
  "settings.updates.action.download": "Thinksoft letöltése",
  "settings.updates.migration.title": "Váltás a Bétáról a Stabil verzióra",
  "settings.updates.migration.description":
    "Az Thinksoft Beta egyelőre átkerül az Thinksoft Stable verzióba. Töltse le a(z) {{version}} verziót, majd telepítse az Thinksoft-ot a lemezképből a frissítések további fogadásához.",
}
