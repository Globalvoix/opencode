export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "help.tabs.introduction": "Thinksoft Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
