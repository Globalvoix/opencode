export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "help.tabs.introduction": "Теперь работа в Thinksoft Desktop организована с помощью вкладок.",
  "help.tabs.sessions":
