export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "help.tabs.introduction": "Thinksoft Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
