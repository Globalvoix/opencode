...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Thinksoft failed to load",
  "desktop.recovery.terminated": "Thinksoft window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Thinksoft is not responding",
  ...
  "desktop.wsl.error.installOpencode": "Thinksoft installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Thinksoft is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Thinksoft update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
