export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "help.tabs.introduction": "Thinksoft Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
