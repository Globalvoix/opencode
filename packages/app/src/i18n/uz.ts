export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "help.tabs.introduction": "Thinksoft Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
