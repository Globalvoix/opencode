export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen आपको कोडिंग एजेंटों के लिए चुने गए विश्वसनीय, अनुकूलित मॉडलों तक पहुँच देता है।",
  ...
  "help.tabs.introduction": "Thinksoft Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
