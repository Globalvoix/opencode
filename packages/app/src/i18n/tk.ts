export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  ...
  "help.tabs.introduction": "Thinksoft Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
