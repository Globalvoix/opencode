export const dict: Record<string, string> = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen ඔබට කේතීකරණ නියෝජිතයන් සඳහා විශ්වාසදායක ප්‍රශස්ත මාදිලි සමූහයකට ප්‍රවේශය ලබා දෙයි.",
  ...
  "help.tabs.introduction": "Thinksoft ඩෙස්ක්ටොප් එක දැන් ටැබ් වටා ගොඩනගා ඇත.",
  "help.tabs.sessions":
