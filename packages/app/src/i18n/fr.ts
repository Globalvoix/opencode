export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "help.tabs.introduction": "Thinksoft Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
