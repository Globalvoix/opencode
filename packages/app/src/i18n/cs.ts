export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "help.tabs.introduction": "Thinksoft Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
