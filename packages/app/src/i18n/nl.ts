export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "help.tabs.introduction": "Thinksoft Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
