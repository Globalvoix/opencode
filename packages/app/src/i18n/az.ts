export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "help.tabs.introduction": "Thinksoft Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
