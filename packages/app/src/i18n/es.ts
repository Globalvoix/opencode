export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "help.tabs.introduction": "Thinksoft Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
