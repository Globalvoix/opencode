export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "help.tabs.introduction": "Thinksoft Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
