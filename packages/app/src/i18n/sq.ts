export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "help.tabs.introduction": "Thinksoft Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
