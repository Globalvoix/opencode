export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "help.tabs.introduction": "Thinksoft L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
