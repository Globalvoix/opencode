export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "help.tabs.introduction": "Thinksoft Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
