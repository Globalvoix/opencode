...
export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "help.tabs.introduction": "Radna površina Thinksoft sada je izgrađena oko kartica.",
  "help.tabs.sessions":
