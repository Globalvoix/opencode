export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  ...
  "help.tabs.introduction": "Thinksoft Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
