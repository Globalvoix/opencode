export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "help.tabs.introduction": "Agora, o Thinksoft Desktop é organizado em abas.",
  "help.tabs.sessions":
