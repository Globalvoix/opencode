export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "help.tabs.introduction": "Thinksoft Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
