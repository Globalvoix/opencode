...
export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "help.tabs.introduction": "Thinksoft Desktop is now built around tabs.",
  "help.tabs.sessions":
