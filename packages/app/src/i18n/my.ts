export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen သည် သင့်အား coding အေးဂျင့်များအတွက် ယုံကြည်စိတ်ချရသော အကောင်းဆုံးပုံစံများဖြင့် စုစည်းထားသော မော်ဒယ်များကို ဝင်ရောက်ခွင့်ပေးသည်။",
  ...
  "help.tabs.introduction": "Thinksoft Desktop သည် ယခုအခါ တက်ဘ်များအနီးတွင် တည်ဆောက်ထားသည်။",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "ဤအမှားအယွင်းကို Thinksoft အဖွဲ့ထံ တိုင်ကြားပါ။\nDiscord တွင်",
