export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "help.tabs.introduction": "Thinksoft Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
