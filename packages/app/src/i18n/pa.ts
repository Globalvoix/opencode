export const dict = {
  ...
  "help.tabs.introduction": "Thinksoft Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Thinksoft ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
