export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "help.tabs.introduction": "Thinksoft Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
