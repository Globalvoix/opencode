export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen به شما امکان دسترسی به مجموعه‌ای از مدل‌های بهینه‌شده قابل اعتماد را برای عوامل کدنویسی می‌دهد.",
  ...
  "help.tabs.introduction": "Thinksoft Desktop اکنون در اطراف زبانه ها ساخته شده است.",
  "help.tabs.sessions":
