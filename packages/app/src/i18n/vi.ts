export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "help.tabs.introduction": "Thinksoft Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
