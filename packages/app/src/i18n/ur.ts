export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  ...
  "help.tabs.introduction": "Thinksoft Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Thinksoft ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
