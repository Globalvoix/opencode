export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Thinksoft Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "help.tabs.introduction": "Thinksoft Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
