...
const Root = Spec.make(typeof OPENCODE_CLI_NAME === "string" ? OPENCODE_CLI_NAME : "opencode", {
  description: "Thinksoft command line interface",
  params: {
    ...ServerParams,
    ...PermissionParams,
    directory: Argument.string("directory").pipe(
      Argument.withDescription("Directory to start Thinksoft in"),
      Argument.optional,
    ),
  ...
  commands: [
    Spec.make("upgrade", {
      description: "Upgrade Thinksoft to the latest or a specific version",
      aliases: ["update"],
      params: {
    ...
    Spec.make("uninstall", {
      description: "Uninstall Thinksoft and remove all related files",
      params: {
    ...
    Spec.make("run", {
      description: "Run Thinksoft with a message",
      params: {
        ...ServerParams,
