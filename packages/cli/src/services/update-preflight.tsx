...
const stages = ["Keeping your session safe", "Starting the new background service", "Loading Thinksoft"] as const
...
function UpdateFooter(props: {
  ...
  const pausedHeader = phrase(["Thinksoft", colors.muted, true], ["update paused", colors.muted])
  const outcomeStatus = () =>
